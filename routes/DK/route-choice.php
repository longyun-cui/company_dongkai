...
//Route::match(['get', 'post'], '/choice_api/okcc/receivingResult', $controller.'@operate_api_okcc_receivingResult');
Route::any('/choice_api/okcc/receivingResult', $controller.'@operate_api_okcc_receivingResult');
