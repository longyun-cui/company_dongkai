...
Route::match(['get','post'], '/cc_api/lxy/receiving-result', $controller.'@operate_api_LXY_receiving_result');
...
//    Route::match(['get','post'], '/my-account/my-password-change', $controller.'@operate_my_account_password_change');
    ...
    Route::post('/pool/telephone-download-of-second', $controller.'@operate_pool_telephone_download_of_second');
