...
Route::group(['middleware' => ['dk.staff.user.login','dk.staff.user.password_change']], function () {
    ...
    Route::post('/o1/project/item-team--get', $controller.'@o1__project__item_team__get');
    Route::post('/o1/project/item-staff--get', $controller.'@o1__project__item_staff__get');
    Route::post('/o1/project/item-save', $controller.'@o1__project__item_save');
    Route::post('/o1/project/item-team-set--save', $controller.'@o1__project__item_team_set__save');
    Route::post('/o1/project/item-staff-set--save', $controller.'@o1__project__item_staff_set__save');
    // 【项目】删除 & 恢复 & 永久删除
    ...
    Route::post('/o1/statistic/production/order/rejected', $controller.'@o1__statistic__production__order__rejected');
    // 【生产统计】
    ...
    Route::post('/o1/statistic/production/inspector-overview', $controller.'@o1__statistic__production__inspector_overview');
    Route::post('/o1/statistic/production/operator-overview', $controller.'@o1__statistic__production__operator_overview');
    // 【交付统计】
