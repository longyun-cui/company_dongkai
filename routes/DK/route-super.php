...
Route::group(['middleware' => ['yh.super.login']], function () {
    ...
    Route::get('/', $controller.'@view__super__index');
    Route::get('/301', $controller.'@view__super__301');
    Route::get('/403', $controller.'@view__super__403');
    Route::get('/404', $controller.'@view__super__404');
