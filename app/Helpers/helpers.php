...
// 时间差 计算【天】
if(!function_exists('time_subtract_of_day'))
{
    function time_subtract_on_day($stamp_1,$stamp_2) {
        return floor(($stamp_1 - $stamp_2) / 86400);
    }
}
// 时间差 计算【小时】
if(!function_exists('time_subtract_on_hour'))
{
    function time_subtract_o_hour($stamp_1,$stamp_2) {
        return floor(($stamp_1 - $stamp_2) % 86400 / 3600);
    }
}
// 时间差 计算【分钟】
if(!function_exists('time_subtract_on_minute'))
{
    function time_subtract_on_minute($stamp_1,$stamp_2) {
        return ceil(($stamp_1 - $stamp_2) % 86400 / 60);
    }
}
