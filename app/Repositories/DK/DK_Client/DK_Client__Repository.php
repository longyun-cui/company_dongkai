...
//            exit($e->getMessage());
    ...
    public function v1_operate_for_get_statistic_data_of_production_staff_rank($post_data)
    {
        ...
        // 员工统计
        $query_order = DK_Common__Delivery::select('client_staff_id','delivered_date')
            ->addSelect(DB::raw("
...
//        dd($list->toArray());
    ...
    public function v1_operate_for_get_statistic_data_of_production_staff_daily($post_data)
    {
        ...
        $query_this_month = DK_Common__Delivery::select('client_staff_id','delivered_date')
...
//            'inspected_result'=>'审核结果',
    ...
    public function view_my_profile_info_index()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.my-account.my-profile-info-index';
        return view($view_blade)->with($return);
    }
    // 【基本信息】返回-编辑-视图
    public function view_my_profile_info_edit()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.my-account.my-profile-info-edit';
        return view($view_blade)->with($return);
    }
    // 【基本信息】保存数据
...
//            exit($e->getMessage());
    ...
    public function view_my_account_password_change()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.my-account.my-account-password-change';
        return view($view_blade)->with($return);
    }
    // 【密码】保存数据
...
//        dd($district_array);
    ...
    public function view_department_list($post_data)
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.department.department-list';
        return view($view_blade)->with($return);
    }
    // 【部门管理】返回-列表-数据
    ...
    public function view_department_modify_record($post_data)
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.item.department-list-for-all';
        return view($view_blade)->with($return);
    }
    // 【部门管理】【修改记录】返回-列表-数据
...
//        dd($list->toArray());
    ...
    public function view_department_create()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.department.department-edit';
    ...
    public function view_department_edit()
    {
        ...
        else
        {
            ...
            if($mine)
            {
//                if(!in_array($mine->user_category,[1,9,11,88])) return view(env('DK_CLIENT__TEMPLATE').'errors.404');
            ...
            else return view(env('DK_CLIENT__TEMPLATE').'errors.404');
        }
    }
    // 【部门管理】保存数据
...
//        if($item->owner_id != $me->id) return response_error([],"该内容不是你的，你不能操作！");
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.item.item-assign-html-for-attachment';
...
//        if(!is_numeric($type)) return view(env('DK_CLIENT__TEMPLATE').'errors.404');
//        if(!in_array($type,[1,2,3,10,11,88])) return view(env('DK_CLIENT__TEMPLATE').'errors.404');
    ...
    public function view_user_staff_list($post_data)
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.user.staff-list';
        return view($view_blade)->with($return);
    }
    // 【用户-员工管理】返回-列表-数据
...
//        dd($list->toArray());
    ...
    public function view_user_staff_create()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.user.staff-edit';
        return view($view_blade)->with($view_data);
    }
    // 【用户-员工管理】返回-编辑-视图
...
//                $mine->custom = json_decode($mine->custom);
            ...
            else return view(env('DK_CLIENT__TEMPLATE').'entrance.errors.404');
        }
    }
    // 【用户-员工管理】保存数据
...
//            exit($e->getMessage());
    ...
    public function view_item_delivery_list($post_data)
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.item.delivery-list';
        return view($view_blade)->with($view_data);
    }
    // 【交付管理】返回-列表-数据
...
//        dd($view_data);
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.item.order-list-for-all';
        return view($view_blade)->with($view_data);
    }
    // 【工单管理】返回-列表-数据
...
//        dd($list->toArray());
    ...
    public function view_item_order_create()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.item.order-edit';
        return view($view_blade)->with($return);
    }
    // 【工单管理】返回-编辑-视图
    public function view_item_order_edit()
    {
        ...
        else
        {
            ...
            if($mine)
            {
//                if($mine->deleted_at) return view(env('DK_CLIENT__TEMPLATE').'entrance.errors.404');
//                else
                {
                    $mine->custom = json_decode($mine->custom);
                    $mine->custom2 = json_decode($mine->custom2);
...
//            $item->trailer = $item->outside_trailer;
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.item.order-info-html';
...
//        if($item->owner_id != $me->id) return response_error([],"该内容不是你的，你不能操作！");
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.item.order-assign-html-for-attachment';
        $html = view($view_blade)->with(['item_list'=>$item->attachment_list])->__toString();
...
//        dd($view_data);
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.finance.daily-list';
        return view($view_blade)->with($view_data);
    }
    // 【财务】返回-列表-数据
...
//        dd($list->toArray());
    ...
    public function view_statistic_index()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-index';
        return view($view_blade)->with($view_data);
    }
    // 【统计】
    public function view_statistic_user($post_data)
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-user';
        return view($view_blade)->with($view_data);
    }
    // 【统计】
    public function view_statistic_item($post_data)
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-item';
        return view($view_blade)->with($view_data);
    }
    // 【统计】返回（后台）主页视图
...
//        $return_data['finance_last_month_payout'] = $finance_last_month_payout;
    ...
    public function view_statistic_rank()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-rank';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function view_statistic_rank_by_staff()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-rank-by-staff';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function view_statistic_rank_by_department()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-rank-by-department';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function view_statistic_customer_service()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-customer-service';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function view_statistic_inspector()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-inspector';
        return view($view_blade)->with($view_data);
    }
...
//                else $v[$key]->order_average_rate_for_inspected = 0;
    ...
    public function view_statistic_list_for_all($post_data)
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-list-for-all';
        return view($view_blade)->with($view_data);
    }
    // 【流量统计】返回-列表-数据
...
//        dd($list->toArray());
    ...
    public function view_statistic_delivery_by_daily()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-delivery-by-daily';
        return view($view_blade)->with($view_data);
    }
...
//        dd($list->toArray());
    ...
    public function get_statistic_data_for_delivery_of_daily_list_datatable($post_data)
    {
        ...
        // 交付统计
        $query = DK_Common__Delivery::select('id','created_at')
            ->where('client_id',$me->client_id)
            ->groupBy(DB::raw("DATE(FROM_UNIXTIME(created_at))"))
            ->addSelect(DB::raw("
...
//        dd($statistics_data_for_daily->toArray());
    ...
    public function view_statistic_export()
    {
        ...
        $view_blade = env('DK_CLIENT__TEMPLATE').'entrance.statistic.statistic-export';
        return view($view_blade)->with($view_data);
    }
    // 【数据导出】工单
