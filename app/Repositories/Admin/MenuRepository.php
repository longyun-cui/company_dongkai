...
//            }
    ...
    public function view_items()
    {
        ...
        {
            unset($mine->id);
            return view('admin.menu.items')->with(['encode_id'=>$id, 'data'=>$mine]);
        }
    ...
    {
        return view('admin.menu.edit')->with(['operate'=>'create', 'encode_id'=>encode(0)]);
    }
    ...
    public function view_edit()
    {
        ...
        if($decode_id == 0) return view('admin.menu.edit')->with(['operate'=>'create', 'encode_id'=>$id, 'category'=>'']);
        else
        {
            ...
            {
                unset($mine->id);
                return view('admin.menu.edit')->with(['operate'=>'edit', 'encode_id'=>$id, 'data'=>$mine, 'category'=>'']);
            }
            else return response("该目录不存在！", 404);
        }
    }
