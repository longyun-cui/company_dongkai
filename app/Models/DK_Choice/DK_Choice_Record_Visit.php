...
class DK_Choice_Record_Visit extends Model
{
    //
    protected $table = "dk_choice_record_by_visit";
    protected $fillable = [
    ...
    function owner()
    {
        return $this->belongsTo('App\Models\DK\K_User','owner_id','id');
    }
    // 创作者
    function creator()
    {
    ...
    function object()
    {
        return $this->belongsTo('App\Models\DK_Choice\DK_Choice_User','object_id','id');
    }
    ...
    function item()
    {
        return $this->belongsTo('App\Models\DK_Choice\DK_Choice_Item','item_id','id');
    }
