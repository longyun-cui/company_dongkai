...
class DK_Choice_Project extends Model
{
    use SoftDeletes;
    //
    protected $table = "dk_choice_project";
    protected $fillable = [
...
//    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Choice\DK_Choice_User','dk_pivot_user_project','project_id','user_id');
...
//            ->withTimestamps();
    ...
    {
        return $this->belongsToMany('App\Models\DK_Choice\DK_Choice_Department','dk_pivot_team_project','project_id','team_id');
//            ->wherePivot('relation_type', 1);
//            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Choice\DK_Choice_User','pivot_user_item','item_id','user_id');
    }
