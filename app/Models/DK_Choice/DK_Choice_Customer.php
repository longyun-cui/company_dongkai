...
class DK_Choice_Customer extends Authenticatable
{
    use Notifiable;
    use SoftDeletes;
...
//    protected $connection = 'mysql_def';
    ...
    protected $table = "dk_choice_customer";
    ...
    function ext()
    {
        return $this->hasOne('App\Models\DK_Choice\DK_Choice_ClientExt','user_id','id');
    }
