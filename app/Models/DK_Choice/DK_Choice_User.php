...
class DK_Choice_User extends Authenticatable
{
    use Notifiable;
    use SoftDeletes;
...
//    protected $connection = 'mysql_def';
    ...
    protected $table = "dk_choice_user";
    ...
    function ext()
    {
        return $this->hasOne('App\Models\DK_Choice\DK_Choice_UserExt_2','user_id','id');
    }
    ...
    function superior()
    {
        return $this->belongsTo('App\Models\DK_Choice\DK_Choice_User','superior_id','id');
    }
    // 属下员工
    function subordinate_er()
    {
        return $this->hasMany('App\Models\DK_Choice\DK_Choice_User','superior_id','id');
    }
    // 下级的下级
    function through_subordinate_er()
    {
        return $this->hasManyThrough(
            'App\Models\DK_Choice\DK_Choice_User',
            'App\Models\DK_Choice\DK_Choice_User',
            'superior_id',
            'superior_id',
            'id',
    ...
    function order_list()
    {
        return $this->hasMany('App\Models\DK_Choice\DK_Choice_Order','creator_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\DK_Choice\DK_Choice_Order','department_supervisor_id','id');
    }
    // 经理工单
    function order_list_for_manager()
    {
        return $this->hasMany('App\Models\DK_Choice\DK_Choice_Order','department_manager_id','id');
    }

    // 审核人工单
    function order_list_for_inspector()
    {
        return $this->hasMany('App\Models\DK_Choice\DK_Choice_Order','inspector_id','id');
    }
    // 审核人工单
    function order_list_for_deliverer()
    {
        return $this->hasMany('App\Models\DK_Choice\DK_Choice_Order','deliverer_id','id');
    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Choice\DK_Choice_Project','dk_pivot_user_project','user_id','project_id');
...
//            ->withTimestamps();
    ...
    function parent()
    {
        return $this->belongsTo('App\Models\DK_Choice\DK_Choice_User','parent_id','id');
    }

    // 名下代理商
    function children()
    {
        return $this->hasMany('App\Models\DK_Choice\DK_Choice_User','parent_id','id');
    }
    ...
    function pivot_user()
    {
        return $this->belongsToMany('App\Models\DK_Choice\DK_Choice_User','pivot_user_user','user_1_id','user_2_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Choice\DK_Choice_User','pivot_user_relation','mine_user_id','relation_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Choice\DK_Choice_User','pivot_user_relation','relation_user_id','mine_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
