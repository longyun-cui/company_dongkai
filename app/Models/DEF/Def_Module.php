...
class Def_Module extends Model
{
    //
...
//    }
    ...
    function menus()
    {
        return $this->hasMany('App\Models\RootMenu','module_id','id');
    }

    // 多对多 关联的目录
    function pivot_menus()
    {
        return $this->belongsToMany('App\Models\RootMenu','root_pivot_module_menu','module_id','menu_id');
    }
