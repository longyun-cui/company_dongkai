...
//    }
    ...
    function items()
    {
        return $this->hasMany('App\Models\RootItem','menu_id','id');
    }

    // 多对多 关联的内容
    function pivot_items()
    {
        return $this->belongsToMany('App\Models\RootItem','root_pivot_menu_item','menu_id','item_id');
    }
