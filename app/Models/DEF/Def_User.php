...
class Def_User extends Authenticatable
{
    use Notifiable;
    use SoftDeletes;
    ...
    function ext()
    {
        return $this->hasOne('App\Models\DEF\Def_UserExt','user_id','id');
    }

    // 所属代理商
    function parent()
    {
        return $this->belongsTo('App\Models\DEF\Def_User','parent_id','id');
    }

    // 名下代理商
    function children()
    {
        return $this->hasMany('App\Models\DEF\Def_User','parent_id','id');
    }
    ...
    function pivot_user()
    {
        return $this->belongsToMany('App\Models\DEF\Def_User','pivot_user_user','user_1_id','user_2_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\DEF\Def_User','pivot_user_relation','mine_user_id','relation_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\DEF\Def_User','pivot_user_relation','relation_user_id','mine_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
