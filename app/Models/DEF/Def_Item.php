...
//    }
    ...
    function owner()
    {
        return $this->belongsTo('App\Models\DEF\Def_User','owner_id','id');
    }
    // 创作者
    function creator()
    {
        return $this->belongsTo('App\Models\DEF\Def_User','creator_id','id');
    }
    // 用户
    function user()
    {
        return $this->belongsTo('App\Models\DEF\Def_User','user_id','id');
    }
    ...
    {
        return $this->belongsToMany('App\Models\DEF\Def_User','pivot_user_item','item_id','user_id');
    }
