...
class DK_Customer_Department extends Model
{
    use SoftDeletes;
    //
    protected $table = "dk_customer_department";
    protected $fillable = [
...
//    }
    ...
    {
        return $this->hasMany('App\Models\DK_Customer\DK_Customer_Department','superior_department_id','id');
    }

    // 【反向一对多】上级部门
    function superior_department_er()
    {
        return $this->belongsTo('App\Models\DK_Customer\DK_Customer_Department','superior_department_id','id');
    }
    ...
    function leader()
    {
        return $this->belongsTo('App\Models\DK_Customer\DK_Customer_User','leader_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\DK_Customer\DK_Customer_User','department_district_id','id');
    }
    // 【一对多】部门（大区）员工
    function department_group_staff_list()
    {
        return $this->hasMany('App\Models\DK_Customer\DK_Customer_User','department_group_id','id');
    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Customer\DK_Customer_User','dk_pivot_user_department','department_id','user_id');
...
//            ->withTimestamps();
    ...
    {
        return $this->belongsToMany('App\Models\DK_Customer\DK_Customer_Project','dk_pivot_team_project','team_id','project_id');
//            ->wherePivot('relation_type', 1);
//            ->withTimestamps();
    }
    ...
    {
        return $this->hasMany('App\Models\DK_Customer\DK_Customer_Order','department_district_id','id');
    }
    // 工单
    function order_list_for_group()
    {
        return $this->hasMany('App\Models\DK_Customer\DK_Customer_Order','department_group_id','id');
    }
