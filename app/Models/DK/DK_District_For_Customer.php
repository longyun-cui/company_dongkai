...
class DK_District_For_Customer extends Model
{
    use SoftDeletes;
    //
    protected $table = "dk_admin_district_for_customer";
    protected $fillable = [
        ...
        'district_province', 'district_city', 'district_district', 'postcode', 'area_code',
