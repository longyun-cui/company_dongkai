...
{
    //
    protected $table = "dk_agency_record_by_visit";
    protected $fillable = [
    ...
    function object()
    {
        return $this->belongsTo('App\Models\DK\DK_User','object_id','id');
    }
    ...
    function item()
    {
        return $this->belongsTo('App\Models\DK\DK_Item','item_id','id');
    }
