...
class DK_Finance_Daily extends Model
{
    use SoftDeletes;
    //
    protected $table = "dk_finance_daily";
    protected $fillable = [
        ...
        'manpower_daily_cost', 'material_daily_quantity', 'material_daily_cost', 'taxes_daily_cost', 'total_daily_cost',
