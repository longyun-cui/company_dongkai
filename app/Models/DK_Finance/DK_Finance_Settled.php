...
class DK_Finance_Settled extends Model
{
    use SoftDeletes;
    //
    protected $table = "dk_finance_settled";
    protected $fillable = [
...
//    }
    ...
    function verifier()
    {
        return $this->belongsTo('App\Models\DK_Finance\DK_Finance_User','verifier_id','id');
    }
    // 审核者
    function inspector()
    {
        return $this->belongsTo('App\Models\DK_Finance\DK_Finance_User','inspector_id','id');
    }
    // 运营者
    function deliverer()
    {
        return $this->belongsTo('App\Models\DK_Finance\DK_Finance_User','deliverer_id','id');
    }
    // 完成者
    function completer()
    {
    ...
    {
        return $this->belongsTo('App\Models\DK_Finance\DK_Finance_User','department_manager_id','id');
    }

    // 小组主管
    function department_supervisor_er()
    {
        return $this->belongsTo('App\Models\DK_Finance\DK_Finance_User','department_supervisor_id','id');
    }
