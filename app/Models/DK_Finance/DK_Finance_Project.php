...
class DK_Finance_Project extends Model
{
    use SoftDeletes;
    //
    protected $table = "dk_finance_project";
    protected $fillable = [
...
//    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Finance\DK_Finance_User','dk_pivot_user_project','project_id','user_id');
...
//            ->withTimestamps();
    ...
    {
        return $this->belongsToMany('App\Models\DK_Finance\DK_Finance_Company','dk_pivot_team_project','project_id','team_id');
//            ->wherePivot('relation_type', 1);
//            ->withTimestamps();
    }
