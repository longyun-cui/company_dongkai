...
class DK_Finance_Company extends Model
{
    use SoftDeletes;
    //
    protected $table = "dk_finance_company";
    protected $fillable = [
        'active', 'status', 'category', 'type', 'sort', 'item_active', 'item_status', 'item_category', 'item_type',
        'company_active', 'company_status', 'company_category', 'company_type',
        'owner_active',
        ...
        'finance_recharge_total', 'finance_consumption', 'finance_balance',
...
//    }
    ...
    {
        return $this->hasMany('App\Models\DK_Finance\DK_Finance_Company','superior_company_id','id');
    }

    // 【反向一对多】上级部门
    function superior_company_er()
    {
        return $this->belongsTo('App\Models\DK_Finance\DK_Finance_Company','superior_company_id','id');
    }
    ...
    function leader()
    {
        return $this->belongsTo('App\Models\DK_Finance\DK_Finance_User','leader_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\DK_Finance\DK_Finance_User','department_district_id','id');
    }
    // 【一对多】部门（大区）员工
    function department_group_staff_list()
    {
        return $this->hasMany('App\Models\DK_Finance\DK_Finance_User','department_group_id','id');
    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Finance\DK_Finance_User','dk_pivot_user_department','company_id','user_id');
...
//            ->withTimestamps();
    ...
    {
        return $this->belongsToMany('App\Models\DK_Finance\DK_Project','dk_pivot_team_project','team_id','project_id');
//            ->wherePivot('relation_type', 1);
//            ->withTimestamps();
    }
    ...
    {
        return $this->hasMany('App\Models\DK_Finance\DK_Order','department_district_id','id');
    }
    // 工单
    function order_list_for_group()
    {
        return $this->hasMany('App\Models\DK_Finance\DK_Order','department_group_id','id');
    }
