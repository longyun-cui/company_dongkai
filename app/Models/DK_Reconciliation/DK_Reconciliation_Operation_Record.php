...
class DK_Reconciliation_Operation_Record extends Model
{
    use SoftDeletes;
    //
    protected $table = "dk_reconciliation_operation_record";
    protected $fillable = [
...
//    }
    ...
    {
        return $this->hasMany('App\Models\DK_Client\DK_Client_Department','superior_department_id','id');
    }

    // 【反向一对多】上级部门
    function superior_department_er()
    {
        return $this->belongsTo('App\Models\DK_Client\DK_Client_Department','superior_department_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\DK_Client\DK_Client_User','department_district_id','id');
    }
    // 【一对多】部门（大区）员工
    function department_group_staff_list()
    {
        return $this->hasMany('App\Models\DK_Client\DK_Client_User','department_group_id','id');
    }
    ...
    {
        return $this->belongsToMany('App\Models\DK_Client\DK_Client_User','dk_pivot_user_department','department_id','user_id');
...
//            ->withTimestamps();
    ...
    {
        return $this->belongsToMany('App\Models\DK_Client\DK_Client_Project','dk_pivot_team_project','team_id','project_id');
//            ->wherePivot('relation_type', 1);
//            ->withTimestamps();
    }
    ...
    {
        return $this->hasMany('App\Models\DK_Client\DK_Client_Order','department_district_id','id');
    }
    // 工单
    function order_list_for_group()
    {
        return $this->hasMany('App\Models\DK_Client\DK_Client_Order','department_group_id','id');
    }
