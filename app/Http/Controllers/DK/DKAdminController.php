...
//            $admin = SuperAdministrator::whereEmail($email)->first();
    ...
    // 【工单-管理】
    public function v1_operate_for_order_item_appeal()
    {
        return $this->repo->v1_operate_for_order_item_appeal(request()->all());
    }
    // 【工单-管理】
    public function v1_operate_for_order_item_appeal_handle()
    {
        return $this->repo->v1_operate_for_order_item_appeal_handle(request()->all());
    }
    // 【工单-管理】
    ...
    // 【工单-管理】分发
    public function v1_operate_for_order_item_phone_delivery_record_datatable_query()
    {
        return $this->repo->v1_operate_for_order_item_phone_delivery_record_datatable_query(request()->all());
    }
    // 【工单-管理】分发
    ...
    // 【统计】【通话】成单-城市
    public function v1_operate_for_get_statistic_data_of_statistic_call_order_city()
    {
        return $this->repo->v1_operate_for_get_statistic_data_of_statistic_call_order_city(request()->all());
    }
...
//            }
    ...
    // 【客户】登录
    public function operate_client_login()
    {
        return $this->repo->operate_client_login(request()->all());
    }
    ...
    // 【公司】登录
    public function operate_company_login()
    {
        return $this->repo->operate_company_login(request()->all());
    }
    ...
    // 【订单管理】导入
    public function operate_item_order_import_for_admin_by_txt()
    {
        if(request()->isMethod('get')) return $this->repo->view_item_order_import_for_admin_by_txt();
        else if (request()->isMethod('post')) return $this->repo->operate_item_order_import_for_admin_by_txt_save(request()->all());
    }
...
//        else if(request()->isMethod('post')) return $this->repo->get_statistic_data_for_deliverer(request()->all());
    ...
    // 【统计】交付看板
    public function view_statistic_company_daily()
    {
        if(request()->isMethod('get')) return $this->repo->view_statistic_company_daily(request()->all());
        else if(request()->isMethod('post')) return $this->repo->get_statistic_data_for_company_daily(request()->all());
    }
    ...
    // 【API】【百应】datatable
    public function v1_operate_for_by_datatable_list_query()
    {
        return $this->repo->v1_operate_for_by_datatable_list_query(request()->all());
    }
    // 【API】【百应】操作记录
