...
class UpdatePoolsInitJob implements ShouldQueue
{
...
//            $cdrCurrentTable = (new DK_VOS_CDR_Current)->getTable();
            ...
            try
            {
                ...
                $sql_1 = "
                    ...
                    ON pool.phone = cdr.phone
                    
                    SET
                      pool.call_cnt = cdr.cnt,
                      pool.call_cnt_1_6 = cdr.cnt_1_6,
                      pool.call_cnt_1_8 = cdr.cnt_1_8,
                      pool.call_cnt_9_15 = cdr.cnt_9_15,
                      pool.call_cnt_16_25 = cdr.cnt_16_25,
                      pool.call_cnt_26_45 = cdr.cnt_26_45,
                      pool.call_cnt_46_90 = cdr.cnt_46_90,
                      pool.call_cnt_7_above = cdr.cnt_7_above,
                      pool.call_cnt_9_above = cdr.cnt_9_above,
                      pool.call_cnt_91_above = cdr.cnt_91_above
                    ";
                DB::statement($sql_1);
