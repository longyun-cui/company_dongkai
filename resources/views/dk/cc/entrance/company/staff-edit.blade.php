...
@section('head_title')
    {{ $title_text or '编辑用户' }} - {{ config('info.system.'.$system) }} - {{ config('info.info.short_name') }}
@endsection




@section('header'){{ $title_text or '编辑用户' }}@endsection
        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                ...
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{ url('/company/staff-list') }}";
                    }
                }
            };
