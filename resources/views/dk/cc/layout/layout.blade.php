...
<head>
    ...
    {{--layout-style--}}
    @include(env('TEMPLATE_DK_CC').'layout.layout-style')
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_DK_CC').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_DK_CC').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_DK_CC').'layout.main-content')

    {{--main-footer--}}
{{--    @include(env('TEMPLATE_DK_CC').'layout.main-footer')--}}

    {{--control-sidebar--}}
    @include(env('TEMPLATE_DK_CC').'layout.control-sidebar')
