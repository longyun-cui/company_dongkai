@extends(env('TEMPLATE_DK_FINANCE').'layout.auth')


@section('head_title')
    @if(in_array(env('APP_ENV'),['local']))@endif{{ $title_text or '登录 - 财务系统' }} - {{ config('info.info.short_name') }}
@endsection
