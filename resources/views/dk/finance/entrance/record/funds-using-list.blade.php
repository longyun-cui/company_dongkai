...
@section('head_title')
    {{ $title_text or '结算记录' }} - 财务系统 - {{ config('info.info.short_name') }}
@endsection
...
@section('header','')
@section('description')结算记录 - 财务系统 - {{ config('info.info.short_name') }}@endsection
@section('breadcrumb')
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{ url('/record/funds-using-list') }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
...
@include(env('TEMPLATE_DK_FINANCE').'entrance.record.funds-using-list-script')
@endsection
