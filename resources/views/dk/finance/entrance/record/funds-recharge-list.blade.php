...
@section('head_title')
    {{ $title_text or '财务记录' }} - 财务系统 - {{ config('info.info.short_name') }}
@endsection
...
@section('header','')
@section('description')财务记录 - 财务系统 - {{ config('info.info.short_name') }}@endsection
@section('breadcrumb')
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{ url('/record/funds-recharge-list') }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
...
//                            return $year+'-'+$month+'-'+$day+'&nbsp;&nbsp;'+$hour+':'+$minute+':'+$second;
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            else return '<a href="javascript:void(0);">'+row.company_er.name+'</a>';
...
@include(env('TEMPLATE_DK_FINANCE').'entrance.record.funds-recharge-list-script')
@endsection
