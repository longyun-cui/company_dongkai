...
{{--        @include(env('DK_STAFF__TEMPLATE').'component.module.order.order-dental.order-dental-list--for--OD')--}}
    ...
    {{--AI审核--}}
    @if(in_array($me->staff_category,[0,1,9,71]))
        @include(env('DK_STAFF__TEMPLATE').'component.module.ai.ai-list--for--converted')
    ...
    {{--AI--}}
    @include(env('DK_STAFF__TEMPLATE').'component.module.ai.ai--item-inspecting')
...
{{--    @include(env('DK_STAFF__TEMPLATE').'component.module.order.order-dental.order-dental-edit-script')--}}
    ...
    @elseif(in_array($me->staff_category,[51]))
        ...
        @include(env('DK_STAFF__TEMPLATE').'component.module.order.order-aesthetic.order-aesthetic-list-datatable--for--QID')
    ...
    {{--AI审核--}}
    @if(in_array($me->staff_category,[0,1,9,71]))
        @include(env('DK_STAFF__TEMPLATE').'component.module.ai.ai-list-datatable--for--converted')
        @include(env('DK_STAFF__TEMPLATE').'component.module.ai.ai-list-datatable')
        @include(env('DK_STAFF__TEMPLATE').'component.module.ai.ai-script')
    @endif
