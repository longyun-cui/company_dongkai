                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if(row.usage)
                        {
                            ...
                            $return_html += '【音频消耗】' + row.usage.prompt_tokens_details.audio_tokens + ' <br>';
                            $return_html += '【文本消耗】' + row.usage.prompt_tokens_details.text_tokens + ' <br>';
                            $return_html += '【返回消耗】' + row.usage.completion_tokens + ' <br>';
                            $return_html += ' <br>';
