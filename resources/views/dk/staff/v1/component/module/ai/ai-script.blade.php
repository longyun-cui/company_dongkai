<script>
    $(function() {
        ...
        // 【项目】编辑-提交
        $(".main-wrapper").on('click', ".ai--converted--get-result", function() {
            var $that = $(this);
            ...
            var options = {
                url: "{{ url('/o1/ai/converted--item--get-result') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        // 【ai】获取转文字结果
        $(".main-wrapper").off('click', ".ai--converted--get-result").on('click', ".ai--converted--get-result", function() {
            var $that = $(this);
            ...
            //
            $.post(
                "{{ url('/o1/ai/converted--item--get-result') }}",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "ai--converted--get-result",
