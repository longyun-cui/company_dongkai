<div class="row datatable-body datatable-wrapper ai-converted-record-list-clone" data-datatable-item-category="ai" data-item-name="项目">
    ...
    <div class="col-md-12 datatable-body">
        <div class="box box-primary box-solid-" style="box-shadow:0 0;">
            ...
            <div class="box-body no-padding">
                <div class="tableArea full table-ai margin-top-8px">
