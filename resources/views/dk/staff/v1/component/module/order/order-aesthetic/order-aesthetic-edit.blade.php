            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form-for-order-aesthetic-edit">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 ">
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control modal-select2 select2-reset select2-district-city" name="location_city" id="select-city-3" data-target="#select-district-3">
                            ...
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control select-select2 select2-box-c select2-district-district" name="location_district" id="select-district-3" data-target="#select-city-3">
