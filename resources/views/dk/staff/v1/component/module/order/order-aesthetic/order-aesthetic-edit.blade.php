{{--编辑-工单--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal-for-order-aesthetic-edit">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-64px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form-for-order-aesthetic-edit">
                <div class="box-body">
                    ...
                    <input readonly type="hidden" class="form-control" name="order_category" value="11">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 ">
                            <select class="form-control select2-box-c select2-project" name="project_id" id="order-edit-select2-project" data-item-category="11" style="width:100%;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 ">
                            ...
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control select-select2 select2-box-c select2-district-district" name="location_district" id="select-district-3" data-target="#select-city-3" style="width:100%;">
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit" id="edit-submit-for-order-aesthetic">
