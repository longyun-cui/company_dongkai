<script>
    ...
    $(function() {
        ...
        $(".main-wrapper").on('click', ".modal-show--for--order-dental--item-edit", function() {
            ...
            var $form_id = 'form--for--order-dental--item-edit';
            var $form = $("#"+$form_id);
        ...
        $(".main-wrapper").on('click', ".modal-show--for--order-aesthetic--item-edit", function() {
            ...
            var $form_id = 'form--for--order-aesthetic--item-edit';
            var $form = $("#"+$form_id);
    ...
    `,
        ...
        // 【工单】【申诉确认】显示
        $(".main-wrapper").off('click', ".modal-show--for--order--item-appealed-confirming").on('click', ".modal-show--for--order--item-appealed-confirming", function() {
            var $that = $(this);
            var $id = $that.data('id');
            var $item_id = $that.data('id');
            var $row = $that.parents('tr');
            ...
            var $operation_datatable_id = 'datatable--for--order--item-appealed-confirming--of--operation-record-list';
            Datatable__for__Order_Item_Operation_Record_List.init($operation_datatable_id,$id);


            var $modal_id = 'modal--for--order--item-appealed-confirming';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--order--item-appealed-confirming';
            var $form = $("#"+$form_id);
        ...
        // 【工单】【申诉确认】提交
        $(".main-wrapper").off('click', "#item-submit--for--order--item-appealed-confirming").on('click', "#item-submit--for--order--item-appealed-confirming", function() {
            var $that = $(this);
            var $item_id = $that.data('item-id');
            var $table_id = $that.data('datatable-list-id');
            var $row = $('#'+$table_id).find('[data-key="id"][data-value='+$item_id+']').parents('tr');
            ...
            var options = {
                url: "{{ url('/o1/order/item-appealed-confirming-save') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        // 【工单】【AI质检】显示
        $(".main-wrapper").off('click', ".modal-show--for--order--item-ai-inspecting").on('click', ".modal-show--for--order--item-ai-inspecting", function() {
            var $that = $(this);
            var $id = $that.data('id');
            var $item_id = $that.data('id');
            var $row = $that.parents('tr');
            ...
            var $delivery_datatable_id = 'datatable--for--order--item--ai-inspecting--of--delivery-record-list';
            Datatable__for__Order_Item_Delivery_Record_List.init($delivery_datatable_id,$id);


            var $operation_datatable_id = 'datatable--for--order--item--ai-inspecting--of--operation-record-list';
            Datatable__for__Order_Item_Operation_Record_List.init($operation_datatable_id,$id);
            ...
            var $modal_id = 'modal--for--order--item-ai-inspecting';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--order--item-ai-inspecting';
            var $form = $("#"+$form_id);
            ...
            $.post(
                ...
                .done(function($response, status, jqXHR) {
                    console.log('.'+$that.attr('class')+'.post.done.');
                ...
                .fail(function(jqXHR, status, error) {
                    console.log('.'+$that.attr('class')+'.post.fail.');
                    layer.msg('服务器错误！');

                })
                .always(function(jqXHR, status) {
                    console.log('.'+$that.attr('class')+'.post.always.');
                    layer.closeAll('loading');
                });
        ...
        // 【工单】AI质检
        $(".main-wrapper").off('click', ".item-submit--for--order--item-ai-inspecting--api-sent").on('click', ".item-submit--for--order--item-ai-inspecting--api-sent", function() {
            var $that = $(this);
            ...
            //
            $.post(
                "{{ url('/o1/order/item-inspecting--by-ai') }}",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "order--item-inspecting--by-ai",
                    item_id: $item_id
                },
                'json'
            )
        ...
        $(".main-wrapper").off('click', '.order--bulk-delivering--summit').on('click', '.order--bulk-delivering--summit', function() {
            ...
            layer.msg('确定"批量·交付"么', {
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        "{{ url('/o1/order/bulk-delivering-save') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "order--bulk-delivering--save",
                            ids: $ids,
