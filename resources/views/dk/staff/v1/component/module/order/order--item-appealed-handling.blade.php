{{--处理--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal--for--order--item-appealed-handling">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-16px margin-bottom-64px bg-white">
        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-body datatable-body" id="">
                ...
                <table class='table table-striped table-bordered' id='datatable--for--order--item-appealed-handling--of--operation-record-list'>
                    <thead>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form--for--order--item-appealed-handling">
                <div class="box-body  info-body">

                    {{ csrf_field() }}
                    <input type="hidden" name="operate" value="order--item-appealed-handling" readonly>
                    ...
                    <div class="form-group item-project-box">
                        ...
                        <div class="col-md-9 ">
                            <select class="form-control select2-reset select2--project"
                                    name="project_id"
                                    id="select2--project--for--order--item-appealed-handling"
                        ...
                        <div class="col-md-9 ">
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control modal--select2 select2-reset select2--location-city"
                                        name="location_city"
                                        id="select--location-city--for--order--item-appealed-handling"
                                        data-modal="#modal--for--order--item-appealed-handling"
                                        data-item-category="1"
                                        data-location-district-target="#select2--location-district--for--order--item-appealed-handling"
                                >
                            ...
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control select2-reset select2--location"
                                        ...
                                        id="select2--location-district--for--order--item-appealed-handling"
                                        data-modal="#modal--for--order--item-appealed-handling"
                                        data-item-category="11"
                                        data-target="#select--location-city--for--order--item-appealed-handling"
                                >
                    ...
                    {{--处理结果--}}
                    <div class="form-group">
                        <label class="control-label col-md-2"><sup class="text-red">*</sup> 处理结果</label>
                        <div class="col-md-9 ">
                            ...
                            >
                                ...
                                @foreach(config('dk.common-config.appealed_handled_result') as $k => $v)
                                    <option value ="{{ $k }}">{{ $v }}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit"
                                id="item-submit--for--order--item-appealed-handling"
                                data-modal-id="modal--for--order--item-appealed-handling"
                                data-form-id="form--for--order--item-appealed-handling"
                        >
