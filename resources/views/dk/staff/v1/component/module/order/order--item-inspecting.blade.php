{{--审核--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal--for--order--item-inspecting">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-16px margin-bottom-64px bg-white">
        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-body datatable-body" id="">
                ...
                <table class='table table-striped table-bordered' id='datatable--for--order--item-inspecting--of--delivery-record-list'>
                    <thead>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form--for--order--item-inspecting">
                <div class="box-body  info-body">

                    {{ csrf_field() }}
                    <input type="hidden" name="operate" value="order--item-inspecting" readonly>
                    ...
                    <div class="form-group item-project-box">
                        ...
                        <div class="col-md-9 ">
                            <select class="form-control select2-reset select2--project"
                                    name="project_id"
                                    id="select2--project--for--order--item-inspecting"
                    ...
                    {{--年龄--}}
                    <div class="form-group">
                        <label class="control-label col-md-2">客户年龄</label>
                        <div class="col-md-9 ">
                        ...
                        <div class="col-md-9 ">
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control modal--select2 select2-reset select2--location-city"
                                        name="location_city"
                                        id="select--location-city--for--order--item-inspecting"
                                        data-modal="#modal--for--order--item-inspecting"
                                        data-item-category="1"
                                        data-location-district-target="#select2--location-district--for--order--item-inspecting"
                                >
                            ...
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control select2-reset select2--location"
                                        ...
                                        id="select2--location-district--for--order--item-inspecting"
                                        data-modal="#modal--for--order--item-inspecting"
                                        data-item-category="11"
                                        data-target="#select--location-city--for--order--item-inspecting"
                                >
                        ...
                        <div class="col-md-9 ">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn">
                                    <span class="checkbox">
                                        <label>
                                            <input type="checkbox" name="order--item-inspecting--rejected-reason[]" value="{{ $k }}"> {{ $v }}
                                        </label>
                                    </span>
                                </button>
                                @endforeach
                ...
                <div class="row">
                    <div class="col-md-9 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit"
                                id="item-submit--for--order--item-inspecting"
                                data-modal-id="modal--for--order--item-inspecting"
                                data-form-id="form--for--order--item-inspecting"
                        >
