{{--交付--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal--for--order--item-delivering">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-16px margin-bottom-64px bg-white">
        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-body datatable-body" id="">
                ...
                <table class='table table-striped table-bordered' id='datatable--for--order--item-delivering--of--delivery-record-list'>
                    <thead>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form--for--order--item-delivering">
                <div class="box-body  info-body">

                    {{ csrf_field() }}
                    <input type="hidden" name="operate" value="order--item-delivering" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 ">
                            <select class="form-control select2-reset select2--project"
                                    name="project_id"
                                    id="select2--project--for--order--item-delivering"
                                    data-modal="#modal--for--order--item-delivering"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 ">
                            <select class="form-control select2-reset select2--client"
                                    name="client_id"
                                    id="select2--client--for--order--item-delivering"
                                    data-modal="#modal--for--order--item-delivering"
                                    data-item-category="1"
                            >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 ">
                            <select class="form-control modal--select2 select2-reset"
                                    name="order-item-delivering--delivered-result"
                                    data-modal="#modal--for--order--item-delivering"
                            >
...
{{--                        <div class="col-md-9 ">--}}
{{--                            <input type="text" class="form-control" name="order-item-delivering--recording-address" autocomplete="off" placeholder="" value="">--}}
{{--                        </div>--}}
{{--                    </div>--}}
                    {{--编辑订单--}}
                    <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-9 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit"
                                id="item-submit--for--order--item-delivering"
                                data-modal-id="modal--for--order--item-delivering"
                                data-form-id="form--for--order--item-delivering"
                        >
