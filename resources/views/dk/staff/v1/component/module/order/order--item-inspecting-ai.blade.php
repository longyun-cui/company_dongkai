{{--审核--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal--for--order--item-ai-inspecting">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-16px margin-bottom-64px bg-white">
        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-body datatable-body" id="">
                ...
                <table class='table table-striped table-bordered' id='datatable--for--order--item--ai-inspecting--of--delivery-record-list'>
                    <thead>
        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-body datatable-body" id="">
                ...
                <table class='table table-striped table-bordered' id='datatable--for--order--item--ai-inspecting--of--operation-record-list'>
                    <thead>
                    <tr role='row' class='heading'>
                    </tr>
                    </thead>
        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-body datatable-body" id="">
                ...
                <table class='table table-striped table-bordered' id='datatable--for--order--item--ai-inspecting--of--ai-record-list'>
                    <thead>
                    <tr role='row' class='heading'>
                    </tr>
                    </thead>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form--for--order--item-ai-inspecting">
                <div class="box-body  info-body">

                    {{ csrf_field() }}
                    <input type="hidden" name="operate" value="order--item-ai-inspecting" readonly>
                    ...
                    <div class="form-group item-project-box">
                        ...
                        <div class="col-md-9 ">
                            <select class="form-control select2-reset select2--project"
                                    name="project_id"
                                    id="select2--project--for--order--item-ai-inspecting"
                                    data-modal="#modal--for--order--item-ai-inspecting"
                        ...
                        <div class="col-md-9 ">
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control modal--select2 select2-reset select2--location-city"
                                        name="location_city"
                                        id="select--location-city--for--order--item-ai-inspecting"
                                        data-modal="#modal--for--order--item-ai-inspecting"
                                        data-item-category="1"
                                        data-location-district-target="#select2--location-district--for--order--item-ai-inspecting"
                                >
                            ...
                            <div class="col-sm-6 col-md-6 padding-0">
                                <select class="form-control select2-reset select2--location"
                                        ...
                                        id="select2--location-district--for--order--item-ai-inspecting"
                                        data-modal="#modal--for--order--item-ai-inspecting"
                                        data-item-category="11"
                                        data-target="#select--location-city--for--order--item-ai-inspecting"
                                >
                    ...
                    <div class="form-group item-recording-box">
                        ...
                        <div class="col-md-9 control-label" style="text-align:left;">
                            ...
                            <a class="btn btn-xs item-recording-list-get--for--order--item-ai-inspecting">获取录音</a>
                        ...
                        <div class="col-md-9 col-md-offset-2">
                            <div class="btn-group">
                                <button type="button" class="btn">
                                    <span class="radio">
                                        <label><input type="radio" name="ai-inspecting--recording-speed" value="0.75"> x0.75</label>
                                    </span>
                                </button>
                                <button type="button" class="btn">
                                    <span class="radio">
                                        <label><input type="radio" name="ai-inspecting--recording-speed" value="1"> x1</label>
                                    </span>
                                </button>
                                <button type="button" class="btn">
                                    <span class="radio">
                                        <label><input type="radio" name="ai-inspecting--recording-speed" value="1.25" checked="checked"> x1.25</label>
                                    </span>
                                </button>
                                <button type="button" class="btn">
                                    <span class="radio">
                                        <label><input type="radio" name="ai-inspecting--recording-speed" value="1.5"> x1.5</label>
                                    </span>
                                </button>
                                <button type="button" class="btn">
                                    <span class="radio">
                                        <label><input type="radio" name="ai-inspecting--recording-speed" value="2"> x2</label>
                                    </span>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 ">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn">
                                    <span class="radio">
                                        <label><input type="radio" name="order-item-inspecting--recording-quality" value="0" checked="checked"> 合格</label>
                                    </span>
                                </button>
                                <button type="button" class="btn">
                                    <span class="radio">
                                        <label><input type="radio" name="order-item-inspecting--recording-quality" value="1"> 优秀</label>
                                    </span>
                                </button>
                                <button type="button" class="btn">
                                    <span class="radio">
                                        <label><input type="radio" name="order-item-inspecting--recording-quality" value="9"> 问题</label>
                                    </span>
                                </button>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 ">
                            ...
                            <textarea class="form-control" name="order-item-inspecting--description" rows="3" cols="100%"></textarea>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-9 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit"
                                id="item-submit--for--order--item-ai-inspecting"
                                data-modal-id="modal--for--order--item-ai-inspecting"
                                data-form-id="form--for--order--item-ai-inspecting"
                        >
