<script>
    $(function() {
        ...
        // 【团队】添加-显示
        $(".main-wrapper").on('click', ".modal-show--for--team-item-create", function() {
            var $that = $(this);
        ...
        // 【团队】编辑-显示
        $(".main-wrapper").on('click', ".modal-show--for--team-item-edit", function() {
            var $that = $(this);
            var $row = $that.parents('tr');

            var $modal_id = 'modal--for--team-item-edit';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--team-item-edit';
            var $form = $("#"+$form_id);
        ...
        // 【团队】编辑-显示
        $(".main-wrapper").on('click', ".modal-show--for--team-item-edit--by--super", function() {
            var $that = $(this);
            var $row = $that.parents('tr');

            var $modal_id = 'modal--for--team-item-edit--by--super';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--team-item-edit--by--super';
            var $form = $("#"+$form_id);
            ...
            $.post(
                ...
                .done(function($response, status, jqXHR) {
                    ...
                    else
                    {
                        ...
                        $modal.find('input[name="serverFrom_id"]').val($response.data.serverFrom_id);
                        $modal.find('input[name="serverFrom_name"]').val($response.data.serverFrom_name);
                        $modal.find('input[name="api_customer_account"]').val($response.data.api_customer_account);
        ...
        // 【团队】编辑-提交
        $(".main-wrapper").on('click', "#submit--for--team-item-edit--by--super", function() {
            var $that = $(this);
            ...
            var options = {
                url: "{{ url('/o1/team/item-save--by--super') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        // 【团队】删除
        $(".main-wrapper").off('click', ".team--item-delete-submit").on('click', ".team--item-delete-submit", function() {
            var $that = $(this);
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/team/item-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "team--item-delete",
        ...
        // 【团队】恢复
        $(".main-wrapper").off('click', ".team--item-restore-submit").on('click', ".team--item-restore-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/team/item-restore') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "team--item-restore",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【团队】永久删除
        $(".main-wrapper").off('click', ".team--item-delete-permanently-submit").on('click', ".team--item-delete-permanently-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/team/item-delete-permanently') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "team--item-delete-permanently",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【团队】启用
        $(".main-wrapper").off('click', ".team--item-enable-submit").on('click', ".team--item-enable-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/team/item-enable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "team--item-enable",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【团队】禁用
        $(".main-wrapper").off('click', ".team--item-disable-submit").on('click', ".team--item-disable-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/team/item-disable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "team--item-disable",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【团队】操作记录
        $(".main-content").off('click', ".modal-show--for--team--item-operation-record").on('click', ".modal-show--for--team--item-operation-record", function() {
            var $that = $(this);
            var $id = $(this).data('id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            Datatable__for__Team_Item_Operation_Record_List.init($id);

            var $modal = $('#modal--for--team-item-operation-record-list');
