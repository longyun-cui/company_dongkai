<script>
    ...
    function Datatable__for__BY_List($tableId)
    {
...
//                "scrollY": true,
            ...
            "showRefresh": true,
            "ajax": {
                'url': "{{ url('/o1/by/by-list/datatable-query') }}",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if("{{ in_array($me->user_type,[0,1,11,61,66,71,77]) }}")
                        {
                            ...
                            {
                                $html_detail_inspected = '<a class="btn btn-xs bg-blue modal-show--for--by--item-inspecting" data-id="'+data+'">再审</a>';
                            }
                        }
