<div class="row datatable-body datatable-wrapper delivery-aesthetic-list-clone" data-datatable-item-category="delivery" data-item-name="交付">
    ...
    <div class="col-md-12 datatable-body">
        <div class="box box-primary box-solid- margin-bottom-4px" style="box-shadow:0 0;">
            ...
            <div class="box-body no-padding">
                <div class="tableArea full- table-delivery margin-top-8px">
    ...
    <div class="col-md-12 datatable-search-row">
        <div class="pull-left">
            ...
            <button type="button" onclick="" class="btn btn-default btn-filter bulk-submit-for-delivery-export" id="" data-item-category="11">
