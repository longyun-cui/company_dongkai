<script>
    function Datatable__for__Delivery_List__Duplicate($tableId)
    {
...
//                "scrollY": true,
            "scrollCollapse": true,
            "ajax": {
                'url': "{{ url('/o1/delivery/delivery-duplicate-list/datatable-query') }}",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
...
//                            return $year+'-'+$month+'-'+$day+'&nbsp;&nbsp;'+$hour+':'+$minute+':'+$second;
            ...
            "drawCallback": function (settings) {
                ...
                console.log('delivery-duplicate-list-datatable-execute');
