{{--项目-编辑--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal--for--project--item-team-set">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-24px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form--for--project--item-team-set">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <select class="form-control select2-multiple-reset select2--team" multiple="multiple"
                                name="team_list[]"
                                id="select2--teams--for--project--item-team-set"
                                data-modal="#modal--for--project--item-team-set"
                                data-item-category=""
                                data-item-type="11"
                                data-team-category=""
                                data-team-type=""
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit" id="submit--for--project--item-team-set">
