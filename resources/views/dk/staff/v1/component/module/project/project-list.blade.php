<div class="row datatable-body datatable-wrapper project-list-clone" data-datatable-item-category="project" data-item-name="项目">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class=" pull-left">
            ...
            <button type="button" onclick="" class="btn btn-filter modal-show--for--project-item-create"
                    data-form-id="form--for--project-item-edit"
                    data-modal-id="modal--for--project-item-edit"
                    data-title="添加项目"
            >
    ...
    <div class="col-md-12 datatable-body">
        <div class="box box-primary box-solid-" style="box-shadow:0 0;">
            ...
            <div class="box-body no-padding">
                <div class="tableArea full- margin-top-8px" style="min-width:2000px;">
