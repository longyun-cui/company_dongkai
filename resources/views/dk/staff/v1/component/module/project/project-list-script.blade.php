<script>
    $(function() {
        ...
        // 【项目】编辑-提交
        $(".main-wrapper").on('click', "#submit--for--project--item-team-set", function() {
            var $that = $(this);

            var $table_id = $that.data('datatable-list-id');
            var $table = $('#'+$table_id);

            var $modal_id = 'modal--for--project--item-team-set';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--project--item-team-set';
            var $form = $("#"+$form_id);
            ...
            var options = {
                url: "{{ url('/o1/project/item-team-set--save') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        // 【项目】编辑-显示
        $(".main-wrapper").on('click', ".modal-show--for--project--item-staff-set", function() {
            var $that = $(this);
            var $row = $that.parents('tr');
            ...
            $.post(
                ...
                .done(function($response, status, jqXHR) {
                    ...
                    {
                        form_reset('#form--for--project--item-staff-set');

                        var $modal = $('#modal--for--project--item-staff-set');
        ...
        // 【项目】编辑-提交
        $(".main-wrapper").on('click', "#submit--for--project--item-staff-set", function() {
            var $that = $(this);

            var $table_id = $that.data('datatable-list-id');
            var $table = $('#'+$table_id);

            var $modal_id = 'modal--for--project--item-staff-set';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--project--item-staff-set';
            var $form = $("#"+$form_id);
            ...
            var options = {
                url: "{{ url('/o1/project/item-staff-set--save') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
