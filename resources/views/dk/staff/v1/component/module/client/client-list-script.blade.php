<script>
    $(function() {
        ...
        // 【客户】添加-显示
        $(".main-wrapper").on('click', ".modal-show--for--client-item-create", function() {
            var $that = $(this);
        ...
        // 【客户】编辑-显示-编辑
        $(".main-wrapper").on('click', ".modal-show--for--client-item-edit", function() {
            var $that = $(this);
            ...
            $.post(
                ...
                .done(function($response, status, jqXHR) {
                    ...
                    else
                    {
                        ...
                        form_reset('#form--for--client-item-edit');

                        var $modal = $('#modal--for--client-item-edit');
                        ...
                        $modal.find('input[name="client_category"]').prop('checked', false);
                        $modal.find('input[name="client_category"][value="'+$response.data.client_category+'"]').prop('checked', true).trigger('change');
                        $modal.find('.radio-client-category').hide();
        ...
        // 【客户】编辑-提交
        $(".main-wrapper").on('click', "#submit--for--client-item-edit", function() {
            var $that = $(this);

            var $table_id = $that.data('datatable-list-id');
            var $table = $('#'+$table_id);

            var $modal_id = 'modal--for--client-item-edit';
            var $modal = $("#"+$modal_id);

            var $form_id = 'form--for--client-item-edit';
            var $form = $("#"+$form_id);
        ...
        // 【客户】删除
        $(".main-wrapper").off('click', ".client--item-delete-submit").on('click', ".client--item-delete-submit", function() {
            var $that = $(this);
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/client/item-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "client--item-delete",
        ...
        // 【客户】恢复
        $(".main-wrapper").off('click', ".client--item-restore-submit").on('click', ".client--item-restore-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"恢复"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/client/item-restore') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "client--item-restore",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【客户】永久删除
        $(".main-wrapper").off('click', ".client--item-delete-permanently-submit").on('click', ".client--item-delete-permanently-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"永久删除"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/client/item-delete-permanently') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "client--item-delete-permanently",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【客户】启用
        $(".main-wrapper").off('click', ".client--item-enable-submit").on('click', ".client--item-enable-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"启用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/client/item-enable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "client--item-enable",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【客户】禁用
        $(".main-wrapper").off('click', ".client--item-disable-submit").on('click', ".client--item-disable-submit", function() {
            var $that = $(this);
            var $id = $that.attr('data-id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            layer.msg('确定"禁用"么?', {
                ...
                ,yes: function(index)
                {
                    ...
                    //
                    $.post(
                        "{{ url('/o1/client/item-disable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "client--item-disable",
                            item_category: $item_category,
                            item_id: $that.attr('data-id')
                        },
                        'json'
        ...
        // 【客户】操作记录
        $(".main-content").off('click', ".modal-show--for--client--item-operation-record").on('click', ".modal-show--for--client--item-operation-record", function() {
            var $that = $(this);
            var $id = $(this).data('id');
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            ...
            Datatable__for__Client_Item_Operation_Record_List.init($id);

            var $modal = $('#modal--for--client-item-operation-record-list');
