<script>
    function Datatable__for__Statistic_List__Client_Daily($tableId)
    {
        let $that = $($tableId);
        ...
        $($tableId).DataTable({
            ...
            "scrollCollapse": true,
            "ajax": {
                'url': "{{ url('/o1/statistic-list/statistic-client-daily/datatable-query') }}",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
                    ...
                    d.assign_client = $tableSearch.find('select[name="statistic-list-client-daily-client"]').val();
                },
            },
            // "fixedColumns": {
