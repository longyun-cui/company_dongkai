<script>
    $(function() {
        ...
        $(".main-content").on('click', ".statistic-list-project-daily-create", function() {
            ...
            //
            $.post(
                "{{ url('/o1/statistic-list/statistic-project-daily/daily-create') }}",
                {
        ...
        $(".main-content").on('click', ".item-delete-submit-of-statistic-project-daily", function() {
            ...
            layer.msg('确定"删除"么？', {
                ...
                ,yes: function(index){
                    ...
                    //
                    $.post(
                        "{{ url('/o1/statistic-list/statistic-project-daily/item-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        // 【确认】
        $(".main-content").on('click', ".item-confirm-submit-of-statistic-project-daily", function() {
            var $that = $(this);
            var $row = $that.parents('tr');
            var $datatable_wrapper = $that.closest('.datatable-wrapper');
            var $item_category = $datatable_wrapper.data('datatable-item-category');
            ...
            layer.msg('确定"确认"么？', {
                ...
                ,yes: function(index){
                    ...
                    //
                    $.post(
                        "{{ url('/o1/statistic-list/statistic-project-daily/item-confirm') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('dblclick', ".modal-show-for-item-field-set-of-statistic-project-daily", function() {
            ...
            var $modal = $('#modal-for-item-field-set-of-statistic-project-daily');
            $modal.attr('data-datatable-id',$table_id);
            $modal.attr('data-datatable-row-index',$that.data('row-index'));

            var $form = $('#form-for-item-field-set-of-statistic-project-daily');
            form_reset('#form-for-item-field-set-of-statistic-project-daily');
        ...
        // 【通用】【字段-编辑】【取消】
        $(".main-content").on('click', "#edit-cancel-for-item-field-set-of-statistic-project-daily", function() {
            var that = $(this);
            $('#modal-for-item-field-set-of-statistic-project-daily').modal('hide').on("hidden.bs.modal", function () {
                $("body").addClass("modal-open");
            });

            form_reset('#modal-for-item-field-set-of-statistic-project-daily');
        });
        // 【通用】【字段-编辑】【提交】
        $(".main-content").on('click', "#edit-submit-for-item-field-set-of-statistic-project-daily", function() {
            var $that = $(this);
            var $modal = $('#modal-for-item-field-set-of-statistic-project-daily');
            ...
            //
            var options = {
                url: "{{ url('/o1/statistic-list/statistic-project-daily/item-field-set') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
        ...
        // 【修改记录】【显示】
        $(".main-content").on('click', ".item-modal-show-for-modify-3", function() {
            var that = $(this);
