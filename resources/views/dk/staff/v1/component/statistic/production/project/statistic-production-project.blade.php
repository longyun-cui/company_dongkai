<div class="row datatable-body datatable-wrapper statistic-production-project-clone" data-datatable-item-category="statistic-production-project">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class="pull-right">
            ...
            <select class="search-filter form-filter filter-lg select2-box-c" name="statistic-production-project-order-category">
            ...
            <input type="text" class="search-filter form-filter filter-keyup date-picker-c" name="statistic-production-project-date" placeholder="选择日期" readonly="readonly" value="{{ date('Y-m-d') }}" data-default="{{ date('Y-m-d') }}" />
