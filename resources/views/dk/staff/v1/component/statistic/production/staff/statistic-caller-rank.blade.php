...
{{--            @endif--}}
            ...
            <input type="text" class="search-filter form-filter filter-keyup date-picker-c" name="statistic-caller-rank-date" placeholder="选择日期" readonly="readonly" value="{{ date('Y-m-d') }}" data-default="{{ date('Y-m-d') }}" />
            ...
            {{--按时间段导出--}}
            <input type="text" class="search-filter filter-keyup date-picker-c" name="statistic-caller-rank-start" placeholder="起始时间" readonly="readonly" value="{{ date('Y-m-d') }}" data-default="{{ date('Y-m-d') }}" style="margin-right:-3px;" />
            <input type="text" class="search-filter filter-keyup date-picker-c" name="statistic-caller-rank-ended" placeholder="终止时间" readonly="readonly" value="{{ date('Y-m-d') }}" data-default="{{ date('Y-m-d') }}" />
