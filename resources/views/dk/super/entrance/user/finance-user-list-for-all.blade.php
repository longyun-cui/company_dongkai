...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{ url('/user/finance-user-list-for-all') }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            var html =
                                ...
                                '<a class="btn btn-xs bg-maroon item-finance-password-super-reset-submit" data-id="'+data+'">重置密码</a>'+
                                '<a class="btn btn-xs bg-olive item-finance-login-submit" data-id="'+data+'">登录</a>'+
...
@include(env('TEMPLATE_DK_SUPER').'entrance.user.finance-user-list-script')
@endsection
