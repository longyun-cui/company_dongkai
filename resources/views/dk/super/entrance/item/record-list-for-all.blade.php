...
@section('head_title')
    {{ $title_text or '记录列表' }} - SUPER - {{ config('info.info.short_name') }}
@endsection
...
//                            return data;
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            {
                                var $domain = "{{ env('DOMAIN_DK_ADMIN') }}";
                                return '<a target="_blank" href="'+ $domain +'/item/order-list-for-all?order_id='+data+'" data-id="'+data+'">'+data+'</a>';
                            }
                            return data;
                        }
                    },
...
@include(env('TEMPLATE_DK_SUPER').'entrance.item.record-script')
@endsection
