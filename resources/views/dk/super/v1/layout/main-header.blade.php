...
<header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
        ...
        <span class="logo-mini"><b>超</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>超级系统</b></span>
    </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="header">
                            <a class="modal-show--for--order--import--by-txt"
                               ...
                               data-modal-id="modal--for--order--import--by-txt"
                               data-title="去重导入"
                            >
                                <i class="fa fa-file-text-o text-yellow"></i> 导入工单
                            </a>
                        </li>
                        @endif
