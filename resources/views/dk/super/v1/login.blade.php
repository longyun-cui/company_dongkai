@extends(env('DK_SUPER__TEMPLATE').'layout.auth')


@section('head_title')
    {{ $title_text or 'super登陆' }} - 员工系统 - FNJ
@endsection
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">super登陆</p>
        ...
        <form action="/login" method="post" id="form-admin-login">
            ...
            {{--</div>--}}
            <div class="form-group has-feedback">
                <input type="text" class="form-control" name="login_number" placeholder="登录工号">
