...
@section('head_title')
    {{ $title_text or '财务日报' }} - 自选系统 - {{ config('info.info.short_name') }}
@endsection
            ...
            <div class="box-body datatable-body item-main-body" id="datatable-for-daily-list">
                ...
                <div class="row col-md-12 datatable-search-row">
                    <div class="input-group">
                        ...
                        <select class="form-control form-filter select2-box" name="daily-customer" style="width:120px;">
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "ajax": {
                    ...
                    "data": function (d) {
                        ...
                        d.customer = $('select[name="daily-customer"]').val();
...
@include(env('TEMPLATE_DK_ADMIN_2').'entrance.finance.daily-list-script')
@endsection
