            ...
            <div class="box-body datatable-body item-main-body" id="datatable-for-order-list">
                ...
                <div class="row col-md-12 datatable-search-row">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-filter filter-keyup" name="delivery-order-id" placeholder="工单ID" value="{{ $clue_id or '' }}" style="width:88px;" />
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "ajax": {
                    'url': "{{ url('/item/sales-list') }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                        d._token = $('meta[name="_token"]').attr('content');
                        d.id = $('input[name="delivery-id"]').val();
                        d.clue_id = $('input[name="delivery-order-id"]').val();
                ...
                "columns": [
                   {
                       ...
                       render: function(data, type, row, meta) {
                           return '<label><input type="checkbox" name="bulk-id" class="minimal" value="'+data+'" data-order-id="'+row.clue_id+'"></label>';
                       }
                   },
//                    {
//                        "title": "序号",
...
//                    });
                    ...
                    var $obj = new Object();
                    if($('input[name="order-id"]').val())  $obj.clue_id = $('input[name="order-id"]').val();
...
@include(env('TEMPLATE_DK_ADMIN_2').'entrance.item.sales-list-script')
@endsection
