...
@section('header')<span class="box-title">{{ $title_text or '线索列表' }}</span>@endsection
...
{{--                        <input type="text" class="form-control form-filter filter-keyup" name="clue-customer-name" placeholder="客户姓名" value="{{ $customer_name or '' }}" style="width:88px;" />--}}
                        ...
                        <select class="form-control form-filter select2-box select2-district-city" name="clue-city" id="clue-city" data-target="#clue-district" style="width:120px;height:100%;">
...
{{--                        <select class="form-control form-filter" name="clue-is-wx" style="width:88px;">--}}
...
{{--                        <select class="form-control form-filter" name="clue-is-repeat" style="width:88px;">--}}
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form-inspected-modal">
                <div class="box-body  info-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="operate" value="clue-inspect" readonly>
                    <input type="hidden" name="detail-inspected-clue-id" value="0" readonly>
    ...
    <div class="col-md-6 col-md-offset-3 margin-top-64px margin-bottom-64px bg-white">
        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-body">
                ...
                {{ csrf_field() }}
                <input type="hidden" name="attachment-set-operate" value="item-clue-attachment-set" readonly>
                <input type="hidden" name="attachment-set-clue-id" value="0" readonly>
                ...
                <input type="hidden" name="operate" value="item-clue-attachment-set" readonly>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-text-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="info-text-set-operate" value="item-clue-info-text-set" readonly>
                    <input type="hidden" name="info-text-set-clue-id" value="0" readonly>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-time-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="info-time-set-operate" value="item-clue-info-time-set" readonly>
                    <input type="hidden" name="info-time-set-clue-id" value="0" readonly>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-radio-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="info-radio-set-operate" value="item-clue-info-option-set" readonly>
                    <input type="hidden" name="info-radio-set-clue-id" value="0" readonly>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-select-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="info-select-set-operate" value="item-clue-info-option-set" readonly>
                    <input type="hidden" name="info-select-set-clue-id" value="0" readonly>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-put-on-select-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="put-on-set-operate" value="item-clue-put-on-option-set" readonly>
                    <input type="hidden" name="put-on-set-operate-type" value="add" readonly>
                    <input type="hidden" name="put-on-set-clue-id" value="0" readonly>
                    ...
                    <div class="form-group _none">
                        ...
                        <div class="col-md-8 " id="put-on-set-distributed-clue-list">
                        </div>
                    </div>
                    <div class="form-group _none">
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-distribute-select-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="distribute-set-operate" value="item-clue-distribute-option-set" readonly>
                    <input type="hidden" name="distribute-set-operate-type" value="add" readonly>
                    <input type="hidden" name="distribute-set-clue-id" value="0" readonly>
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-2">已交付订单</label>
                        <div class="col-md-8 " id="distribute-set-distributed-clue-list">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-2">已分发客户</label>
...
{{--添加订单--}}
<div class="modal fade modal-main-body" id="modal-body-for-clue-create">
    <div class="col-md-9 col-md-offset-2 margin-top-64px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container">
            ...
            @include(env('TEMPLATE_DK_ADMIN_2').'component.clue-create')
...
//                                $more_html+
                    ...
                    },
                    {
                        ...
                        "orderSequence": ["desc", "asc"],
                        render: function(data, type, row, meta) {
                            if(data) return '<a target="_blank" href="/item/choice-list?choice_id='+data+'">'+data+'</a>';
                            return "--";
                        }
                    },
//                     {
...
//                     },
                    ...
                    // },
                    {
                        ...
                        "fnCreatedCell": function (nTd, data, row, iRow, iCol) {
                            if(!("{{ in_array($me->user_type,[84,88]) }}" && row.is_published == 1) || ("{{ in_array($me->user_type,[84,88]) }}" && row.inspected_result == "二次待审"))
                            {
                                ...
                                $(nTd).attr('data-key','customer_name').attr('data-value',data);
                    ...
                    },
                    {
                        ...
                        "fnCreatedCell": function (nTd, data, row, iRow, iCol) {
                            if(!("{{ in_array($me->user_type,[84,88]) }}" && row.is_published == 1) || ("{{ in_array($me->user_type,[84,88]) }}" && row.inspected_result == "二次待审"))
                            {
                                ...
                                $(nTd).attr('data-key','customer_phone').attr('data-value',data);
                    ...
                    {{--            $(nTd).attr('data-key','customer_intention').attr('data-value',data);--}}
                    ...
                    },
                    {
                        ...
                        "fnCreatedCell": function (nTd, data, row, iRow, iCol) {
                            if(row.is_completed != 1 && row.item_status != 97)
                            {
                                ...
                                $(nTd).attr('data-column-name','线索描述');
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "/item/clue-modify-record?id="+$id,
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                        d._token = $('meta[name="_token"]').attr('content');
...
@include(env('TEMPLATE_DK_ADMIN_2').'entrance.item.clue-list-script')
