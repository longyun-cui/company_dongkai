...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('FAVICON_DK_AGENCY') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('FAVICON_DK_AGENCY') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('FAVICON_DK_AGENCY') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('FAVICON_DK_AGENCY') }}">
    ...
    {{--layout-style--}}
    @include(env('TEMPLATE_DK_AGENCY').'layout.layout-style')
...
|---------------------------------------------------------|
-->
<body class="hold-transition skin-green sidebar-mini sidebar-collapse- sidebar-expanded-on-hover">
<div class="wrapper">


    {{--main-header--}}
    @include(env('TEMPLATE_DK_AGENCY').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_DK_AGENCY').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_DK_AGENCY').'layout.main-content')

    {{--main-footer--}}
{{--    @include(env('TEMPLATE_DK_AGENCY').'layout.main-footer')--}}

    {{--control-sidebar--}}
    @include(env('TEMPLATE_DK_AGENCY').'layout.control-sidebar')
