<script>
    $(function() {
        ...
        $("#datatable-for-department-list").on('click', ".filter-submit", function() {
            $('#datatable-for-department-list').DataTable().ajax.reload();
        });
        // 【重置】
                ...
                ,yes: function(index){
                    $.post(
                        ...
                        function(data){
                            ...
                            {
                                $('#datatable-for-department-list').DataTable().ajax.reload(null,false);
                            }
                        },
                        'json'
                    );
...
////                                TableDatatablesAjax_inner.init($keyword_id);
                                ...
                                $('#datatable-for-department-list').DataTable().ajax.reload(null, false);
//                                $('#datatable-for-department-list_inner').DataTable().ajax.reload(null, false);
                            }
                        },
                        'json'
                    );
