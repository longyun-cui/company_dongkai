<script>
    var Table_DatatableAjax_department_record = function ($id) {
        var datatableAjax_department_record = function ($id) {

            var dt_department_record = $('#datatable_ajax_record');
            dt_department_record.DataTable().destroy();
            var ajax_datatable_department_record = dt_department_record.DataTable({
                "retrieve": true,
                "destroy": true,
...
//                    });
            ...
            dt_department_record.on('click', '.modify-filter-submit', function () {
                ajax_datatable_department_record.ajax.reload();
            });

            dt_department_record.on('click', '.modify-filter-cancel', function () {
...
//            dt_department_record.on('click', '#all_checked', function () {
...
//            });
        ...
        return {
            init: datatableAjax_department_record
        }
    }();
    //        $(function () {
    //            Table_DatatableAjax_department_record.init();
    //        });
</script>
