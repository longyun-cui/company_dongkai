<script>
    var Table_DatatableAjax_department_list = function () {
        var datatableAjax_department_list = function () {

            var dt_department_list = $('#datatable-for-department-list');
            var ajax_datatable_department_list = dt_department_list.DataTable({
...
//                    });
        ...
        return {
            init: datatableAjax_department_list
        }
    }();
</script>