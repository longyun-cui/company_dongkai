<script>
    var Table_DatatableAjax_order_record = function ($id) {
        var datatableAjax_order_record = function ($id) {

            var dt_order_record = $('#datatable_ajax_record');
            dt_order_record.DataTable().destroy();
            var ajax_datatable_order_record = dt_order_record.DataTable({
                "retrieve": true,
                "destroy": true,
                "aLengthMenu": [[10, 50, 200, -1], ["10", "50", "200", "全部"]],
                "bAutoWidth": false,
                "processing": true,
                "serverSide": true,
                "searching": false,
...
//                    });
        ...
        return {
            init: datatableAjax_order_record
        }
    }();
</script>