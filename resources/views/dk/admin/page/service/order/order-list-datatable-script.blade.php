<script>
    var Table_DatatableAjax_order_list = function () {
        var datatableAjax_order_list = function () {
...
//                    });
            ...
            dt_order_list.on('click', '.filter-submit', function () {
                ajax_datatable_order_list.ajax.reload();
            });
    ...
    $(function () {
        ...
        // TableDatatablesAjax_order_list.init();
