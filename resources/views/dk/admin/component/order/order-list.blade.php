        ...
        <div class=" pull-left">
            ...
            @if(in_array($me->department_district_id,[0]))
                @if(in_array($me->user_type,[0,1,9,11,61,66,71,77]))
                    ...
                    {{--交付项目--}}
                    <select class="search-filter form-filter filter-lg select2-box-c select2-project-c" name="bulk-operate-delivered-project">
                    ...
                    {{--交付客户--}}
                    <select class="search-filter form-filter filter-lg select2-box-c" name="bulk-operate-delivered-client">
