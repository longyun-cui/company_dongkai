{{--修改-属性-信息--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal-for-item-field-set-of-statistic-client-daily">
    <div class="modal-content col-md-6 col-md-offset-3 margin-top-64px margin-bottom-64px bg-white">
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="form-for-item-field-set-of-statistic-client-daily">
                <div class="box-body">
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success" id="edit-submit-for-item-field-set-of-statistic-client-daily">
                            <i class="fa fa-check"></i> 提交
                        </button>
                        <button type="button" class="btn btn-default" id="edit-cancel-for-item-field-set-of-statistic-client-daily">
                            取消
                        </button>
                    </div>
                </div>
