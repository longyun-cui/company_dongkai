<script>
    $(function() {
        ...
        $(".main-content").on('click', ".item-delete-submit-of-statistic-client-daily", function() {
            ...
            layer.msg('确定"删除"么？', {
                ...
                ,yes: function(index){
                    ...
                    //
                    $.post(
                        "{{ url('/v1/operate/statistic-list/statistic-client-daily/item-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', ".item-confirm-submit-of-statistic-client-daily", function() {
            ...
            layer.msg('确定"确认"么？', {
                ...
                ,yes: function(index){
                    ...
                    //
                    $.post(
                        "{{ url('/v1/operate/statistic-list/statistic-client-daily/item-confirm') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
        ...
        $(".main-content").on('click', "#edit-submit-for-item-field-set-of-statistic-client-daily", function() {
            ...
            //
            var options = {
                url: "{{ url('/v1/operate/statistic-list/statistic-client-daily/item-field-set') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                // clearForm: true,
