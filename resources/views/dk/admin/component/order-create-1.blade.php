...
{{--    </div>--}}
    ...
    <div class="form-group location-select-box">
        ...
        <div class="col-md-8 ">
            <div class="col-sm-6 col-md-6 padding-0">
                <select class="form-control select2-modal-order-create  location-select-city-from-city" name="location_city_code" style="width:100%;">
                    <option value="-1">选择城市</option>
                    @foreach(config('location_city.city_list') as $k => $v)
                        <option value="{{ $k }}">{{ $v }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-sm-6 col-md-6 padding-0">
                <select class="form-control select2-modal-order-create  location-select-district-from-city" name="location_district_code" style="width:100%;">
