<script>
    function Table_Datatable_Ajax_Statistic_Production_Project($tableId)
    {
        let $that = $($tableId);
        ...
        $($tableId).DataTable({
            ...
            "orderCellsTop": true,
            "ajax": {
                'url': "{{ url('/v1/operate/statistic/production/project') }}",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
                    d._token = $('meta[name="_token"]').attr('content');
                    d.id = $tableSearch.find('input[name="production-project-id"]').val();
                    d.name = $tableSearch.find('input[name="production-project-name"]').val();
                    ...
                    d.department_district = $tableSearch.find('select[name="statistic-production-project-department-district"]').val();
                    d.department_group = $tableSearch.find('select[name="statistic-production-project-department-group"]').val();
