{{--编辑-客户--}}
<div class="modal fade modal-main-body modal-wrapper" id="modal-for-client-edit">
    <div class="modal-content col-md-8 col-md-offset-2 margin-top-64px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered" id="form-for-client-edit">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <input type="text" class="form-control" name="username" placeholder="客户名称" value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <input type="text" class="form-control" name="ip_whitelist" placeholder="ip白名单" value="">
                    </div>
                </div>
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-success edit-submit" id="edit-submit-for-client">
