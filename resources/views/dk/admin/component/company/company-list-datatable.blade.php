<script>
    function Datatable_for_CompanyList($tableId)
    {
...
//                "scrollY": true,
            "scrollCollapse": true,
            "ajax": {
                'url': "{{ url('/v1/operate/company/datatable-list-query') }}",
                "type": 'POST',
                "dataType" : 'json',
                "data": function (d) {
                    ...
                    d.username = $tableSearch.find('input[name="company-username"]').val();
                    d.user_status = $tableSearch.find('select[name="company-user-status"]').val();
                    ...
                    d.work_status = $tableSearch.find('select[name="work_status"]').val();
                },
            },
            "fixedColumns": {
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        var html =
                            ...
                            '<a class="btn btn-xs btn-primary- company-edit-show" data-id="'+data+'">编辑</a>'+
                            $html_able+
...
//                            return $year+'-'+$month+'-'+$day+'&nbsp;&nbsp;'+$hour+':'+$minute+':'+$second;
            ...
            "drawCallback": function (settings) {
                ...
                console.log('company-list-datatable-execute');
