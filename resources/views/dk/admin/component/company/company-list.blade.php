<div class="row datatable-body datatable-wrapper company-list-clone" data-datatable-item-category="company" data-item-name="渠道">
    ...
    <div class="col-md-12 datatable-search-row  datatable-search-box">
        ...
        <div class=" pull-left">
            ...
            <button type="button" onclick="" class="btn btn-filter btn-success- item-create-modal-show"
                    data-form-id="form-for-company-edit"
                    data-modal-id="modal-for-company-edit"
                    data-title="添加渠道"
            >
        ...
        <div class="pull-right">
            ...
            <input type="text" class="search-filter form-filter filter-keyup" name="company-id" placeholder="ID">
