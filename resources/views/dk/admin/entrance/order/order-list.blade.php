            ...
            <div class="box box-primary main-list-body" style="margin-bottom:0;">
                ...
                <div class="col-md-12 datatable-search-row" id="datatable-search-for-order-list" style="margin-top:8px;">
                    ...
                    <div class="pull-left">
                        ...
                        {{--选择团队--}}
                        @if(in_array($me->user_type,[0,1,9,11,61,66,71,77]))
                        <select class="search-filter form-filter filter-xl select2-box" name="order-department-district[]" id="order-department-district" multiple="multiple">
                        ...
                        <select class="search-filter form-filter filter-lg select2-box order-select2-staff" name="order-staff">
                        ...
                        <select class="search-filter form-filter filter-lg select2-box order-select2-client" name="order-client">
                        ...
                        {{--选择项目--}}
                        <select class="search-filter form-filter filter-lg select2-box order-select2-project" name="order-project">
                            @if($project_id > 0)
                        ...
                        {{--审核状态--}}
                        <select class="search-filter form-filter filter-lg select2-box" name="order-inspected-status">
                        ...
                        <button type="button" onclick="" class="btn btn-success btn-filter item-create-show pull-right">
                ...
                <div class="box-footer datatable-search-row" id="">
                    ...
                    <div class=" pull-left">
                        ...
                        @if(in_array($me->user_type,[0,1,9,11,61,66,71,77]))
                            ...
                            {{--交付项目--}}
                            <select class="search-filter form-filter filter-lg select2-box order-select2-project" name="bulk-operate-delivered-project">
                            ...
                            {{--交付客户--}}
                            <select class="search-filter form-filter filter-lg select2-box" name="bulk-operate-delivered-client">
                            ...
                            {{--交付结果--}}
                            <select class="search-filter form-filter filter-lg select2-box" name="bulk-operate-delivered-result">
