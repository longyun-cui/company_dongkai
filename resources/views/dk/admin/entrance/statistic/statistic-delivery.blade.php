...
@section('head_title')
    {{ $title_text or '交付(项目)看板' }}
@endsection




@section('title')<span class="box-title">{{ $title_text or '交付（项目）看板' }}</span>@endsection
@section('header')<span class="box-title">{{ $title_text or '交付（项目）看板' }}</span>@endsection
        ...
        <div class="col-md-12">
            <div class="box box-info main-list-body">
                ...
                <div class="box-header with-border" style="margin:4px 0;">
                    <h3 class="box-title">
                        【<span class="statistic-title-">交付（项目）看板</span>】
