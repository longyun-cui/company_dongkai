...
@section('head_title')
    {{ $staff->username or '员工' }}
@endsection


@section('title')<span class="box-title">{{ $title_text or '员工' }}</span>@endsection
@section('header')<span class="box-title">{{ $title_text or '员工' }}</span>@endsection
