            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-select-set-form">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 ">
                            <select class="form-control select2-inspector" name="info-select-set-column-value" multiple="multiple" style="width:240px;" id="">
...
//                            return data;
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            if(row.operate_category == 1)
                            {
                                ...
                                else if(data == "project_type") return '车辆类型';
                                else if(data == "project_owner") return '所有人';
                                else if(data == "project_function") return '使用性质';
                                else if(data == "project_brand") return '品牌';
                                else if(data == "project_identification_number") return '车辆识别代码';
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            else if(row.column_name == 'project_id' || row.column_name == 'trailer_id')
                            {
