...
{{--                </div>--}}
                ...
                <div class="form-group _none">
                    ...
                    <div class="col-md-8 ">
                        <div class="col-sm-6 col-md-6 padding-0">
                            <input type="text" class="form-control" name="custom_location_city" placeholder="所在城市" value="{{ $data->location_city or '' }}" id="custom-city">
                        </div>
                        <div class="col-sm-6 col-md-6 padding-0">
                            <input type="text" class="form-control" name="custom_location_district" placeholder="所在区域" value="{{ $data->location_district or '' }}" id="custom-district">
                        </div>
                    </div>
                </div>
