...
@section('head_title')
    {{ $title_text or '地域列表' }} - 管理员系统 - {{ config('info.info.short_name') }}
@endsection
            ...
            <div class="box-body datatable-body item-main-body" id="datatable-for-district-list">
                ...
                <div class="row col-md-12 datatable-search-row">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-filter item-search-keyup" name="district-title" placeholder="名称" />
...
{{--                        </select>--}}
                        ...
                        <select class="form-control form-filter" name="district-status" style="width:96px;">
    ...
    <div class="col-md-6 col-md-offset-3 margin-top-64px margin-bottom-64px bg-white">
        ...
        <div class="box- box-info- form-container">
            ...
            <div class="box-header with-border margin-top-16px margin-bottom-16px">
                <h3 class="box-title">修改地域【<span class="info-text-set-title"></span>】</h3>
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-text-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="info-text-set-operate" value="item-district-info-text-set" readonly>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-time-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="info-time-set-operate" value="item-district-info-text-set" readonly>
                    {{--<input type="hidden" name="info-time-set-operate" value="item-district-info-time-set" readonly>--}}
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-radio-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="info-radio-set-operate" value="item-district-info-option-set" readonly>
                    <input type="hidden" name="info-radio-set-district-id" value="0" readonly>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-info-select-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="info-select-set-operate" value="item-district-info-option-set" readonly>
        ...
        <div class="box- box-info- form-container">
            ...
            <form action="" method="post" class="form-horizontal form-bordered " id="modal-attachment-set-form">
                <div class="box-body">
                    ...
                    {{ csrf_field() }}
                    <input type="hidden" name="attachment-set-operate" value="item-district-attachment-set" readonly>
                    <input type="hidden" name="attachment-set-district-id" value="0" readonly>
                    ...
                    <input type="hidden" name="operate" value="item-district-attachment-set" readonly>
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{ url('/district/district-list') }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                        d._token = $('meta[name="_token"]').attr('content');
                        d.id = $('input[name="district-id"]').val();
                        d.name = $('input[name="district-name"]').val();
                        d.title = $('input[name="district-title"]').val();
                        d.keyword = $('input[name="district-keyword"]').val();
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "/district/district-modify-record?id="+$id,
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                        d._token = $('meta[name="_token"]').attr('content');
