...
//            $('select[name=info-select-set-column-value]').find("option").eq(0).attr("selected","selected");
            ...
            if($that.attr("data-key") == "location_city")
            {
                ...
                var $district_list = [
                    ...
                    ['渝中区','江北区','沙坪坝区','九龙坡区','南岸区','北碚 bèi 区','渝北区','巴南区','万州区','涪fú陵区','永川区','璧山区','大足区','綦qí江区','江津区','合川区','黔qián江区','长寿区','南川区','铜梁区','潼tóng南区','荣昌区','开州区','梁平区','武隆区','城口县','丰都县','垫江县','忠县','云阳县','奉节县','巫山县','巫溪县','石柱土家族自治县','秀山土家族苗族自治县','酉阳土家族苗族自治县','彭水苗族土家族自治县'],
