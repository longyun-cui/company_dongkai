...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('DK_CLIENT__FAVICON') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('DK_CLIENT__FAVICON') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('DK_CLIENT__FAVICON') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('DK_CLIENT__FAVICON') }}">
    ...
    {{--layout-style--}}
    @include(env('DK_CLIENT__TEMPLATE').'layout.layout-style')
{{--    @include(env('DK_CLIENT__TEMPLATE').'layout.layout-style-for-mobile')--}}
...
<div class="wrapper main-wrapper">
    ...
    {{--main-header--}}
    @include(env('DK_CLIENT__TEMPLATE').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('DK_CLIENT__TEMPLATE').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('DK_CLIENT__TEMPLATE').'layout.main-content')

    {{--main-footer--}}
{{--    @include(env('DK_CLIENT__TEMPLATE').'layout.main-footer')--}}

    {{--control-sidebar--}}
{{--    @include(env('DK_CLIENT__TEMPLATE').'layout.control-sidebar')--}}
...
{{--layout-script--}}
@include(env('DK_CLIENT__TEMPLATE').'layout.layout-script-for-common')
@include(env('DK_CLIENT__TEMPLATE').'layout.layout-script-for-tab')
@include(env('DK_CLIENT__TEMPLATE').'layout.layout-script-for-datatable')
@include(env('DK_CLIENT__TEMPLATE').'layout.layout-script-for-item-edit')
@include(env('DK_CLIENT__TEMPLATE').'layout.layout-script')
