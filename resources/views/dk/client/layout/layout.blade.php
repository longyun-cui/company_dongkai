...
<head>
    ...
    {{--layout-style--}}
    @include(env('TEMPLATE_DK_CLIENT').'layout.layout-style')
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_DK_CLIENT').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_DK_CLIENT').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_DK_CLIENT').'layout.main-content')

    {{--main-footer--}}
{{--    @include(env('TEMPLATE_DK_CLIENT').'layout.main-footer')--}}

    {{--control-sidebar--}}
    @include(env('TEMPLATE_DK_CLIENT').'layout.control-sidebar')
