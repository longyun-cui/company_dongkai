...
{{--layout-script--}}
@include(env('TEMPLATE_DK_CLIENT').'layout.layout-script-for-tab')
@include(env('TEMPLATE_DK_CLIENT').'layout.layout-script-for-datatable')
@include(env('TEMPLATE_DK_CLIENT').'layout.layout-script-for-item-edit')
