...
@section('head_title')
    {{ $title_text or '部门列表' }} - 客户系统 - {{ config('info.info.short_name') }}
@endsection
...
@section('header','')
@section('description')部门列表 - 客户系统 - {{ config('info.info.short_name') }}@endsection
@section('breadcrumb')
...
@include(env('TEMPLATE_DK_CUSTOMER').'entrance.department.department-list-script')
@endsection
