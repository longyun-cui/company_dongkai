<script>
    $(function() {
        ...
        // 【搜索】
        $("#datatable-for-telephone-list").on('click', ".filter-submit", function() {
            $('#datatable_ajax').DataTable().ajax.reload();
        });
        // 【刷新】
        $("#datatable-for-telephone-list").on('click', ".filter-refresh", function() {
            $('#datatable_ajax').DataTable().ajax.reload(null,false);
        });
        // 【重置】
        $("#datatable-for-telephone-list").on('click', ".filter-cancel", function() {
            $("#datatable-for-telephone-list").find('textarea.form-filter, input.form-filter, select.form-filter').each(function () {
                $(this).val("");
            });
...
//            $('select.form-filter').selectpicker('refresh');
            $("#datatable-for-telephone-list").find('select.form-filter option').attr("selected",false);
            $("#datatable-for-telephone-list").find('select.form-filter').find('option:eq(0)').attr('selected', true);

            $('#datatable_ajax').DataTable().ajax.reload();
        });
        // 【清空重选】
        $("#datatable-for-telephone-list").on('click', ".filter-empty", function() {
            $("#datatable-for-telephone-list").find('textarea.form-filter, input.form-filter, select.form-filter').each(function () {
                $(this).val("");
            });
            $(".select2-box").val(-1).trigger("change");
...
//            $('select.form-filter').selectpicker('refresh');
        ...
        // 【查询】回车
        $("#datatable-for-telephone-list").on('keyup', ".filter-keyup", function(event) {
            if(event.keyCode ==13)
            {
                $("#datatable-for-telephone-list").find(".filter-submit").click();
            }
        });


        // 【完整显示】
        $(".main-content").on('click', "#telephone-show-for-full", function() {
        ...
        // 【简要显示】
        $(".main-content").on('click', "#telephone-show-for-brief", function() {
        ...
        // 【财务显示】
        $(".main-content").on('click', "#telephone-show-for-finance", function() {
        ...
        $(".main-content").on('click', ".date-pick-pre-for-order", function() {
            ...
            var $assign_dom = $('input[name="telephone-assign"]');
        ...
        $(".main-content").on('click', ".item-create-show", function() {
            var $that = $(this);
            $('#modal-body-for-telephone-create').modal('show');
        });
        // 【编辑】
        $(".main-content").on('click', ".item-create-link", function() {
            var $that = $(this);
            var $url = "/item/telephone-create?&referrer="+encodeURIComponent(window.location.href);
        ...
        $(".main-content").on('click', ".item-edit-link", function() {
            var $that = $(this);
            var $url = "/item/telephone-edit?id="+$that.attr('data-id')+"&referrer="+encodeURIComponent(window.location.href);
            window.location.href = $url;
            // window.open($url);
        });
        // 【编辑】
        $(".main-content").on('click', ".item-import-link", function() {
            var $that = $(this);
            var $url = "/item/telephone-import?&referrer="+encodeURIComponent(window.location.href);
            window.location.href = $url;
            // window.open($url);
        });
        ...
        $(".main-content").on('click', ".item-modal-show-for-detail", function() {
            ...
            {{--    dataType:'json',--}}
            {{--    async:false,--}}
            {{--    url: "{{ url('/item/telephone-get-html') }}",--}}
            {{--    data: {--}}
...
//            $('input[name=id]').val($that.attr('data-id'));
            $('input[name=info-set-telephone-id]').val($that.attr('data-id'));
        ...
        $(".main-content").on('click', ".item-modal-show-for-detail-inspected", function() {
            ...
            $('input[name="detail-inspected-telephone-id"]').val($that.attr('data-id'));
            $('.info-detail-title').html($that.attr('data-id'));
            $('.info-set-title').html($that.attr('data-id'));
        ...
        $(".main-content").on('click', ".item-summit-for-detail-inspected", function() {
            ...
            var $id = $('input[name="detail-inspected-telephone-id"]').val();
            ...
            $.post(
                "{{ url('/item/telephone-inspect') }}",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "telephone-inspect",
                    item_id: $('input[name="detail-inspected-telephone-id"]').val(),
        ...
        $(".main-content").on('click', ".item-modal-show-for-push", function() {
            ...
            $('input[name=info-select-set-telephone-id]').val($that.attr("data-id"));
...
//            $('select[name=info-select-set-column-value]').find('option').eq(0).attr('data-id',$that.attr("data-value"));
        ...
        $(".main-content").on('click', ".item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/telephone-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-delete",
        ...
        $(".main-content").on('click', ".item-abandon-submit", function() {
            ...
            layer.msg('确定"弃用"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/telephone-abandon') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-abandon",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-reuse-submit", function() {
            ...
            layer.msg('确定"复用"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/telephone-reuse') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-reuse",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-publish-submit", function() {
            ...
            layer.msg('确定"发布"么？', {
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        "{{ url('/item/telephone-publish') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-publish",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
        ...
        $(".main-content").on('click', ".item-complete-submit", function() {
            ...
            layer.msg('确定"完成"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/telephone-complete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-complete",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-verify-submit", function() {
            ...
            layer.msg('确定"审核"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/telephone-verify') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-verify",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-purchase-submit", function() {
            ...
            layer.msg('确定"购买"么？', {
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        "{{ url('/item/telephone-purchase') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-purchase",
                            item_id: $that.attr('data-id')
                        },
                        'json'
                    )
        ...
        $(".main-content").on('click', ".item-put-on-show", function() {
            ...
            $('input[name=put-on-set-telephone-id]').val($that.attr("data-id"));
            $('input[name=put-on-set-column-key]').val($that.attr("data-key"));
            $('#put-on-set-distributed-list').html('');
            $('#put-on-set-distributed-telephone-list').html('');
        ...
        $(".main-content").on('click', "#item-submit-for-put-on-set", function() {
            ...
            layer.msg('确定"上架"么？', {
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        "{{ url('/item/telephone-put-on-shelf') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-put-on",
                            item_id: $('input[name="put-on-set-telephone-id"]').val(),
        ...
        $(".main-content").on('click', '#bulk-submit-for-put-on-shelf', function() {
            ...
            // var $url = url_build('/statistic/statistic-export-for-telephone-by-ids?ids='+$ids);
            // window.open($url);
            ...
            layer.msg('确定"批量上架"么', {
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        "{{ url('/item/telephone-put-on-shelf-by-bulk') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-put-on-bulk",
                            ids: $ids,
        ...
        $(".main-content").on('click', ".item-put-off-submit", function() {
            ...
            layer.msg('确定"上架"么？', {
                ...
                ,yes: function(index) {
                    ...
                    $.post(
                        "{{ url('/item/telephone-put-off-shelf') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-put-off",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
        ...
        $(".main-content").on('click', ".item-distribute-submit", function() {
            ...
            $.post(
                "{{ url('/item/telephone-put-on-get-delivered') }}",
                {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate: "telephone-put-on-get-delivered",
                    item_id: $that.attr('data-id')
                },
                function(data){
                    ...
                    else
                    {
                        ...
                        layer.open({
                            ...
                            ,yes: function(index){
                                $.post(
                                    "{{ url('/item/telephone-distribute') }}",
                                    {
                                        _token: $('meta[name="_token"]').attr('content'),
                                        operate: "telephone-distribute",
                                        item_id: $that.attr('data-id'),
        ...
        $(".main-content").on('click', ".item-distribute-show", function() {
            ...
            $('input[name=distribute-set-telephone-id]').val($that.attr("data-id"));
            $('input[name=distribute-set-column-key]').val($that.attr("data-key"));
            $('#distribute-set-distributed-list').html('');
            $('#distribute-set-distributed-telephone-list').html('');
            ...
            $.post(
                ...
                function(data){
                    ...
                    else
                    {
                        ...
                        $('#distribute-set-distributed-telephone-list').html($html_for_order);
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        "{{ url('/item/telephone-distribute') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-distribute",
                            item_id: $('input[name="distribute-set-telephone-id"]').val(),
        ...
        $(".main-content").on('click', "#item-submit-for-travel-set", function() {
            ...
            layer.msg('确定"添加"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/telephone-travel-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: $('input[name="travel-set-operate"]').val(),
                            order_id: $('input[name="travel-set-telephone-id"]').val(),
        ...
        $(".main-content").on('dblclick', ".modal-show-for-info-text-set", function() {
            ...
            $('input[name=info-text-set-telephone-id]').val($that.attr("data-id"));
        ...
        $(".main-content").on('click', "#item-submit-for-info-text-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/item/telephone-info-text-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: $('input[name="info-text-set-operate"]').val(),
                            order_id: $('input[name="info-text-set-telephone-id"]').val(),
        ...
        $(".main-content").on('dblclick', ".modal-show-for-info-time-set", function() {
            ...
            $('input[name=info-time-set-telephone-id]').val($that.attr("data-id"));
        ...
        $(".main-content").on('click', "#item-submit-for-info-time-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/item/telephone-info-time-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: $('input[name="info-time-set-operate"]').val(),
                            order_id: $('input[name="info-time-set-telephone-id"]').val(),
        ...
        $(".main-content").on('dblclick', ".modal-show-for-info-radio-set", function() {
            ...
            $('input[name=info-radio-set-telephone-id]').val($that.attr("data-id"));
        ...
        $(".main-content").on('click', "#item-submit-for-info-radio-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/item/telephone-info-radio-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: $('input[name="info-radio-set-operate"]').val(),
                            order_id: $('input[name="info-radio-set-telephone-id"]').val(),
...
//            $('select[name=info-select-set-column-value]').find("option").eq(0).attr("selected","selected");
        ...
        $(".main-content").on('click', "#item-submit-for-info-select-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/item/telephone-info-select-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: $('input[name="info-select-set-operate"]').val(),
                            order_id: $('input[name="info-select-set-telephone-id"]').val(),
...
//                                $('#datatable_ajax_inner').DataTable().ajax.reload(null, false);
        ...
        $(".main-content").on('dblclick', ".modal-show-for-attachment", function() {
            ...
            $.ajax({
                ...
                dataType:'json',
                async:false,
                url: "{{ url('/item/telephone-get-attachment-html') }}",
                data: {
                    _token: $('meta[name="_token"]').attr('content'),
                    operate:"item-get",
                    order_id: $that.attr('data-id')
        ...
        $(".main-content").on('click', "#item-submit-for-attachment-set", function() {
            ...
            var $index = layer.load(1, {
                ...
                success: function (layer) {
                    ...
                    var options = {
                        url: "{{ url('/item/telephone-info-attachment-set') }}",
                        type: "post",
                        dataType: "json",
                        // target: "#div2",
                        success: function (data) {
...
//                                $('#datatable_ajax_inner').DataTable().ajax.reload(null, false);
        ...
        // 【附件-attachment-属性】【删除】
        $(".main-content").on('click', ".telephone-attachment-delete-this", function() {
            var $that = $(this);
            layer.msg('确定"删除"么？', {
                time: 0
                ,btn: ['确定', '取消']
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/telephone-info-attachment-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
...
//                                $('#datatable_ajax').DataTable().ajax.reload(null,false);
        ...
        $(".main-content").on('click', '#bulk-submit-for-delivered', function() {
            ...
            layer.msg('确定"批量上架"么', {
                ...
                ,yes: function(index){
                    ...
                    $.post(
                        "{{ url('/item/telephone-bulk-deliver') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "telephone-delivered-bulk",
                            ids: $ids,
        ...
        // select2 项目
        $('.telephone-select2-project').select2({
            ajax: {
                url: "{{ url('/item/item_select2_project') }}",
                dataType: 'json',
                delay: 250,
