...
@section('header')<span class="box-title">{{ $title_text or '线索公海' }}</span>@endsection
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "ajax": {
                    'url': "{{ url('/item/clue-list?clue_type='.$clue_type) }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
...
//                    },
                    ...
                    // },
                    {
                        ...
                        "fnCreatedCell": function (nTd, data, row, iRow, iCol) {
                            ...
                            $(nTd).attr('data-id',row.id).attr('data-name','接单情况');
