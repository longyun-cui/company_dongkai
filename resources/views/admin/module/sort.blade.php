    ...
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                <h3 class="box-title">模块排序</h3>
                <span>（拖动排序）</span>
                <input type="hidden" id="marking" data-key="1000">
            </div>

            <form action="" method="post" class="form-horizontal form-bordered" id="form-sort-module">
                <div class="box-body" id="sortable">
                    ...
                    <div class="box-body sort-option" data-id="{{$v->encode_id or ''}}">
                        <input type="hidden" name="module[{{$k}}][id]" value="{{$v->id or ''}}">
                        {{--标题--}}
            ...
            <div class="box-footer">
                <div class="row" style="margin:16px 0;">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-primary" id="sort-module-submit"><i class="fa fa-check"></i> 保存排序</button>
...
$(function() {
    ...
    // 修改排序
    $("#sort-module-submit").on('click', function() {
        var options = {
            url: "{{url(config('common.org.admin.prefix').'/admin/module/sort')}}",
            type: "post",
            dataType: "json",
            // target: "#div2",
...
//                    location.reload();
        ...
        $("#form-sort-module").ajaxSubmit(options);
    });
