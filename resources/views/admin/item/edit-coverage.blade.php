...
@section('create-text',"添加资讯")
@section('edit-text',"编辑资讯")
@section('list-text',"资讯列表")
...
@section('breadcrumb')
    ...
    <li><a href="{{ url('/admin/item/list?category=coverage') }}"><i class="fa "></i> @yield('list-text')</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="category" value="41" readonly>
        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                ...
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url('/admin/item/list?category=coverage')}}";
                    }
                }
            };
