...
@section('create-text') 添加选择我们 @endsection
@section('edit-text') 添加选择我们 @endsection
@section('list-text') 选择我们列表 @endsection
...
@section('breadcrumb')
    ...
    <li><a href="{{ url('/admin/item/list?category=advantage') }}"><i class="fa "></i> @yield('list-text')</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="category" value="5" readonly>
        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                ...
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url('/admin/item/list?category=advantage')}}";
                    }
                }
            };
