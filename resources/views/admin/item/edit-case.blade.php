...
@section('create-text') 添加案例 @endsection
@section('edit-text') 添加案例 @endsection
@section('list-text') 关于案例 @endsection
    ...
    <div class="col-md-12">
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-body">
                ...
                <input type="hidden" name="category" value="21" readonly>
