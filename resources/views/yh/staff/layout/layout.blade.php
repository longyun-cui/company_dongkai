...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ url('yh.jpg') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ url('yh.ico') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ url('yh.jpg') }}">
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_YH_STAFF').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_YH_STAFF').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_YH_STAFF').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_YH_STAFF').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_YH_STAFF').'layout.control-sidebar')
...
{{--@include(env('TEMPLATE_ZY_STAFF').'layout.wx-script')--}}


<script src="{{ asset('/resource/common/js/common.js') }}"></script>
<script src="{{ asset('/resource/custom/zy-staff/frontend/js/index.js') }}"></script>

@include(env('TEMPLATE_YH_STAFF').'layout.layout-script')
