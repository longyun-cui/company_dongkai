...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('YH_FAVICON') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('YH_FAVICON') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('YH_FAVICON') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('YH_FAVICON') }}">
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_YH_ADMIN').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_YH_ADMIN').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_YH_ADMIN').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_YH_ADMIN').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_YH_ADMIN').'layout.control-sidebar')
