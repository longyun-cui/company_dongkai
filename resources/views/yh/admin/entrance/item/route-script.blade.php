<script>
    $(function() {
        ...
        // 【搜索】
        $("#datatable-for-route-list").on('click', ".filter-submit", function() {
            $('#datatable_ajax').DataTable().ajax.reload();
        });
        // 【重置】
        $("#datatable-for-route-list").on('click', ".filter-cancel", function() {
            $("#datatable-for-route-list").find('textarea.form-filter, input.form-filter, select.form-filter').each(function () {
                $(this).val("");
            });

//            $('select.form-filter').selectpicker('refresh');
            $("#datatable-for-route-list").find('select.form-filter option').attr("selected",false);
            $("#datatable-for-route-list").find('select.form-filter').find('option:eq(0)').attr('selected', true);

            $('#datatable_ajax').DataTable().ajax.reload();
        });
        // 【查询】回车
        $("#datatable-for-route-list").on('keyup', ".filter-keyup", function(event) {
            if(event.keyCode ==13)
            {
                $("#datatable-for-route-list").find(".filter-submit").click();
            }
        });
        ...
        $(".main-content").on('click', ".item-edit-link", function() {
            var $that = $(this);
            window.location.href = "/item/route-edit?id="+$that.attr('data-id');
        });
        ...
        $(".main-content").on('click', ".item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/route-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-delete",
        ...
        $(".main-content").on('click', ".item-abandon-submit", function() {
            ...
            layer.msg('确定"弃用"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/route-abandon') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-abandon",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-publish-submit", function() {
            ...
            layer.msg('确定"发布"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/route-publish') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-publish",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-complete-submit", function() {
            ...
            layer.msg('确定"完成"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/route-complete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-complete",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-delete-submit", function() {
            ...
            layer.msg('确定"删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/route-admin-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-admin-delete",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-restore-submit", function() {
            ...
            layer.msg('确定"恢复"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/route-admin-restore') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-admin-restore",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-delete-permanently-submit", function() {
            ...
            layer.msg('确定"永久删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/route-admin-delete-permanently') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-admin-delete-permanently",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-enable-submit", function() {
            ...
            // });
                    $.post(
                        "{{ url('/item/route-admin-enable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-admin-enable",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-disable-submit", function() {
            ...
            // });
                    $.post(
                        "{{ url('/item/route-admin-disable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "route-admin-disable",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
...
//            $('select[name=info-select-set-column-value]').find("option").eq(0).attr("selected","selected");
        ...
        $(".main-content").on('click', "#item-submit-for-info-select-set", function() {
            ...
            // });
                    ...
                    $.post(
                        "{{ url('/item/route-info-select-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
