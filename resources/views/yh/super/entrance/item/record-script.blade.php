<script>
    $(function() {
        ...
        // 【搜索】
        $("#datatable-for-record-list").on('click', ".filter-submit", function() {
            $('#datatable_ajax').DataTable().ajax.reload();
        });
        // 【重置】
        $("#datatable-for-record-listdatatable-for-record-list").on('click', ".filter-cancel", function() {
            $("#datatable-for-record-list").find('textarea.form-filter, input.form-filter, select.form-filter').each(function () {
                $(this).val("");
            });

//            $('select.form-filter').selectpicker('refresh');
            $("#datatable-for-record-list").find('select.form-filter option').attr("selected",false);
            $("#datatable-for-record-list").find('select.form-filter').find('option:eq(0)').attr('selected', true);

            $('#datatable_ajax').DataTable().ajax.reload();
        });
        // 【查询】回车
        $("#datatable-for-record-list").on('keyup', ".filter-keyup", function(event) {
            if(event.keyCode ==13)
            {
                $("#datatable-for-record-list").find(".filter-submit").click();
            }
        });
        ...
        $(".main-content").on('click', ".item-edit-link", function() {
            var $that = $(this);
            window.location.href = "/item/record-edit?id="+$that.attr('data-id');
        });
        ...
        $(".main-content").on('click', ".item-delete-submit", function() {
            ...
            layer.msg('确定要"删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-delete",
        ...
        $(".main-content").on('click', ".item-abandon-submit", function() {
            ...
            layer.msg('确定要"弃用"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-abandon') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-abandon",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-publish-submit", function() {
            ...
            layer.msg('确定要"发布"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-publish') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-publish",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-complete-submit", function() {
            ...
            layer.msg('确定要"完成"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-complete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-complete",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-delete-submit", function() {
            ...
            layer.msg('确定要"删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-admin-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-admin-delete",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-restore-submit", function() {
            ...
            layer.msg('确定要"恢复"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-admin-restore') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-admin-restore",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-delete-permanently-submit", function() {
            ...
            layer.msg('确定要"永久删除"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-admin-delete-permanently') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-admin-delete-permanently",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-enable-submit", function() {
            ...
            layer.msg('确定"启用"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-admin-enable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-admin-enable",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
        ...
        $(".main-content").on('click', ".item-admin-disable-submit", function() {
            ...
            layer.msg('确定"禁用"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-admin-disable') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            operate: "record-admin-disable",
                            item_id: $that.attr('data-id')
                        },
                        function(data){
                            layer.close(index);
...
//                            else location.reload();
        ...
        $(".main-content").on('click', "#item-submit-for-info-radio-set", function() {
            ...
            layer.msg('确定"提交"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-info-radio-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
...
//            $('select[name=info-select-set-column-value]').find("option").eq(0).attr("selected","selected");
        ...
        $(".main-content").on('click', "#item-submit-for-info-select-set", function() {
            ...
            layer.msg('确定"提交"么？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/item/record-info-select-set') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
